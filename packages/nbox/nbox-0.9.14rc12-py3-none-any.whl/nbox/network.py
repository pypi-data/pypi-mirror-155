...
from .messages import message_to_dict, rpc, field_mask
...
def deploy_job(zip_path: str, job_proto: JobProto):
  ...
  _curl = f"curl -X POST {secret.get('nbx_url')}/api/v1/workpace/{job_proto.auth_info.workspace_id}/job/{job_proto.id}/trigger"
