...
from server_app.stat_window import StatWindow
from server_app.config_window import ConfigWindow
from server_app.add_user import RegisterUser
from server_app.remove_user import DelUserDialog
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, server, config):
        ...
        self.active_clients_table.setFixedSize(780, 480)
