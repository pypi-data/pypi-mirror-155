...
from TTS.tts.layers.vits3.attentions import TextEncoder
from TTS.tts.layers.vits3.models import PosteriorEncoder, ResidualCouplingBlock, StochasticDurationPredictor
...
class Vits(BaseTTS):
    ...
    def __init__(
        ...
        self.text_encoder = TextEncoder(
            ...
            filter_channels=self.args.hidden_channels_ffn_text_encoder,
            n_heads=self.args.num_heads_text_encoder,
            n_layers=self.args.num_layers_text_encoder,
            kernel_size=self.args.kernel_size_text_encoder,
            p_dropout=self.args.dropout_p_text_encoder,
        ...
        self.posterior_encoder = PosteriorEncoder(
            ...
            n_layers=self.args.num_layers_posterior_encoder,
        ...
        self.flow = ResidualCouplingBlock(
            ...
            n_layers=self.args.num_layers_flow,
            n_flows=4,
            cond_channels=self.embedded_speaker_dim,
        )
    ...
    def forward_mas(self, outputs, z_p, m_p, logs_p, x, x_mask, y_mask, g, lang_emb):
        ...
        return outputs, attn, attn_durations
    ...
    def forward(  # pylint: disable=dangerous-default-value
        ...
        # duration predictor
        outputs, attn, attn_durations = self.forward_mas(
            outputs, z_p, m_p, logs_p, x, x_mask, y_mask, g=g, lang_emb=None
        )  # lang_emb)
