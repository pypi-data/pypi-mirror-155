...
class MeshAssembly(AssemblyBase):
    ...
    def associateMeshWithGeometry(self, geometricEntity: str, elements: tuple[MeshElement] = (),
        ...
        geometricEntity
            ...
            the argument *faces* must be specified.If the geometric entity is an Edge object
            then the argument *edges* must be specified.If the geometric entity is a ConstrainedSketchVertex
