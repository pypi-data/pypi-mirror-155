...
class OdbInstanceBase:
    ...
    def __init__(self, name: str, object: OdbPart, localCoordSystem: tuple = ()):
        ...
        localCoordSystem
            ...
            rotation:`localCoordSystem = ((1, 0, 0), (0, 1, 0),                                 (0, 
            0, 1), (10, 0, 0))`The following sequence moves a part 5 units in the *X*-direction with 
            rotation:`localCoordSystem = ((0, 1, 0), (1, 0, 0),                                 (0, 
            0, 1), (5, 0, 0))`transforms a part containing the two points`                           
                  Pt1= (1,0,0)                                  Pt2= (2,0,0)                         
                    `to`                                 Pt1 = (0, 6, 0)                             
                 Pt2 = (0, 7, 0)                                                      ` 
