...
from servicefoundry.internal.const import SERVICE_DEF_FILE_NAME, TEMPLATE_DEF_FILE_NAME
...
from servicefoundry.internal.template.template_parameters import get_template_parameter
