...
from servicefoundry.internal.const import AUTH_UI
...
def _deploy(packaged_output, callback):
    ...
    callback.print_line(f'Your service is being deployed. You can track your deployment at {AUTH_UI}/workspace')
    return deployment
