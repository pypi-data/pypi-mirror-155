...
class User:
    def UserPrint():
        print("Какой модуль вас интересует? \n"
              ...
              "     Функции модуля : \n "
              "         8.1. Функция, решающая задачу поиска экстремума функции методом стохастического"
              " градиентного спуска (SGD). \n"
              "         8.2. Функция, реализующая модель классификации на два класса методом опорных"
              " векторов SVM с применением алгоритма градиентного спуска для минимизации"
        ...
        if userInput == "1.1":
            ...
            if ogr == 1:
                ...
                print("Введите точку до. Пример: 10")
                y_to = float(input())
            SearchExtremes.find(x, y, f, x_from, x_to, y_from, y_to)
        elif userInput == "1.2":
            x, y = 'x', 'y'
            ...
            if ogr == 1:
                ...
                print("Введите точку до. Пример: 10")
                y_to = float(input())
            MethodLagranja.find(x, y, x_y, f, f_x_y, x_from, x_to, y_from, y_to, left_x_y)
        elif userInput == "2.1":
            ...
            if it == 1:
                ...
                iter = int(input())
            print(GoldenSection.find(f, Xl, Xu, e, ea, flag, iter))
        elif userInput == "2.2":
            ...
            if it == 1:
                print("Введите кол-во итераций. Например: 10")
                iter = int(input())
            PorabolMet.find(f, Xl, Xu, e, flag, iter)
        elif userInput == "2.3":
            ...
            #function = BrentMet()
            BrentMet.find(y, a, b, eps, flag, iterations)
        elif userInput == "2.4":
            ...
            if it == 1:
                print("Введите кол-во итераций. Например: 10")
                iter = int(input())
            BFGS.find(f, Xl, Xu, Yl, Yu, np.array([[x], [y]]), e, iter)
        elif userInput == "3.1":
            while True:
            ...
            GradDesentConstStep.find(f, l, lst_xi, iter, e, flag1, flag2, extr)
        elif userInput == "3.2":
            while True:
                print("Какой экстремум вы хотите найти? 1 - максимум \ 0 - минимум")
                q = int(input())
            ...
            GradDesentDrobStep.find(f, l, lst_xi, iter, e, flag1, flag2, extr, pe, delta)
        elif userInput == "3.3":
            while True:
                print("Какой экстремум вы хотите найти? 1 - максимум \ 0 - минимум")
                q = int(input())
            ...
            FastGradDesent.find(f, lst_xi, iter, e, flag1, flag2, extr, namegraph)
            if len(lst_xi) == 1:
            ...
            while True:
                ...
                if q == 1:
                    ...
                    print("Такой команды нет. Введите снова")
            print("Введите функцию f(x1, x2, ... , xn). Например: exp(3*x1) + 5* exp(-2*x2)")
            f = input()
            if extr == 1:
                f = "- (" + f + ")"
                print(f)
            ...
            AdjointGrad.find(f, lst_xi, e, flag1, flag2, extr)
        elif userInput == "4.1":
            y = []
            ...
            LinRegr.find(np.array(y).reshape(-1, 1), X, n, m, reg, L, sigma)
        elif userInput == "4.2":
            y = []
            print("Введите кол-во строк в матрице(n). Например 3")
            n = int(input())
            ...
            print("Введите степень полинома (целое число больше нуля). Например: 1")
            deg = int(input())
            q = -1
            ...
            PolRegres.find(np.array(y).reshape(-1, 1), X, n, m, deg, reg, L, sigma)
        elif userInput == "4.3":
            y = []
            print("Введите кол-во строк в матрице(n). Например 3")
            n = int(input())
            ...
            ExpRegres.find(np.array(y).reshape(-1, 1), X, n, m, reg, L, sigma)
        elif userInput == "5.1":
