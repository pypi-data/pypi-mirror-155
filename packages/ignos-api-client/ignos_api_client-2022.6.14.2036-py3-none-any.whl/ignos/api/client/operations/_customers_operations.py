...
def build_list_ignos_customers_request(
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_upsert_customer_request(
    id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
    ...
    content_type = kwargs.pop('content_type', _headers.pop('Content-Type', None))  # type: Optional[str]
    # Construct URL
    _url = kwargs.pop("template_url", "/erp/customers/{id}")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, 'str'),
    }
...
def build_delete_customer_request(
    id,  # type: str
    **kwargs  # type: Any
):
    # type: (...) -> HttpRequest
...
def build_list_customers_request(
    **kwargs  # type: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/erp/customers")
...
class CustomersOperations(object):
    ...
    def upsert_customer(  # pylint: disable=inconsistent-return-statements
        self,
        id,  # type: str
        body=None,  # type: Optional[_models.UpsertCustomerRequest]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        """Upsert a customer.
    ...
    def upsert_customer(  # pylint: disable=inconsistent-return-statements
        self,
        id,  # type: str
        body=None,  # type: Optional[Union[_models.UpsertCustomerRequest, IO]]
        **kwargs  # type: Any
    ):
        # type: (...) -> None
        """Upsert a customer.
    ...
    @distributed_trace
    def delete_customer(  # pylint: disable=inconsistent-return-statements
        self,
        id,  # type: str
        **kwargs  # type: Any
    ):
    ...
    def list_customers(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> _models.CustomerDtoPagedResult
        """List customers.
