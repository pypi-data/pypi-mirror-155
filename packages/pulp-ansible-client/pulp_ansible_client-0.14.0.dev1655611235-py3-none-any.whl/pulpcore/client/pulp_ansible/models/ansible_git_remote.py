...
class AnsibleGitRemote(object):
    ...
    def __init__(self, headers=None, max_retries=None, name=None, total_timeout=None, download_concurrency=None, sock_connect_timeout=None, rate_limit=None, tls_validation=None, username=None, client_key=None, connect_timeout=None, password=None, proxy_password=None, pulp_labels=None, proxy_username=None, url=None, sock_read_timeout=None, ca_cert=None, client_cert=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
