...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, headers=None, max_retries=None, name=None, total_timeout=None, download_concurrency=None, sock_connect_timeout=None, rate_limit=None, tls_validation=None, connect_timeout=None, pulp_labels=None, url=None, sock_read_timeout=None, pulp_created=None, ca_cert=None, client_cert=None, pulp_href=None, proxy_url=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
