...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, proxy_url=None, rate_limit=None, headers=None, pulp_last_updated=None, pulp_created=None, total_timeout=None, name=None, pulp_href=None, max_retries=None, url=None, sock_read_timeout=None, ca_cert=None, download_concurrency=None, client_cert=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
