...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, download_concurrency=None, headers=None, ca_cert=None, rate_limit=None, proxy_url=None, url=None, password=None, pulp_labels=None, sock_read_timeout=None, name=None, sock_connect_timeout=None, proxy_username=None, client_key=None, max_retries=None, proxy_password=None, username=None, client_cert=None, tls_validation=None, total_timeout=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
