...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, proxy_url=None, total_timeout=None, name=None, headers=None, pulp_labels=None, client_cert=None, sock_connect_timeout=None, sock_read_timeout=None, pulp_href=None, max_retries=None, ca_cert=None, tls_validation=None, download_concurrency=None, rate_limit=None, connect_timeout=None, pulp_created=None, url=None, pulp_last_updated=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
