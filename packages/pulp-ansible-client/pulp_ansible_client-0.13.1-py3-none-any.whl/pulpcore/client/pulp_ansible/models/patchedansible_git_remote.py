...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_url=None, total_timeout=None, name=None, headers=None, pulp_labels=None, client_cert=None, sock_connect_timeout=None, sock_read_timeout=None, proxy_password=None, max_retries=None, ca_cert=None, tls_validation=None, client_key=None, download_concurrency=None, username=None, rate_limit=None, connect_timeout=None, proxy_username=None, url=None, password=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
