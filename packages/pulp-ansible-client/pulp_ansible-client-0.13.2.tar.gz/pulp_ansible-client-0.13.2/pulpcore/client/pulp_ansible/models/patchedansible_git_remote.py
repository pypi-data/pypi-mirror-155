...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, sock_read_timeout=None, ca_cert=None, proxy_password=None, connect_timeout=None, max_retries=None, client_key=None, url=None, password=None, download_concurrency=None, proxy_username=None, sock_connect_timeout=None, client_cert=None, name=None, pulp_labels=None, username=None, rate_limit=None, total_timeout=None, tls_validation=None, headers=None, proxy_url=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
