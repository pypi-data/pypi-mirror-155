...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, proxy_password=None, pulp_labels=None, tls_validation=None, sock_connect_timeout=None, proxy_url=None, rate_limit=None, headers=None, proxy_username=None, password=None, total_timeout=None, name=None, max_retries=None, url=None, sock_read_timeout=None, ca_cert=None, username=None, download_concurrency=None, client_key=None, client_cert=None, connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
