...
# These were proposed in https://jira.iter.org/browse/IMAS-3843 and https://jira.iter.org/projects/IMAS/issues/IMAS-4207
_extra_structures = {
    'equilibrium': {
        'equilibrium.time_slice[:].convergence.delta_relative': {
            "data_type": "STRUCTURE",
            "documentation": "Description of error in the Grad-Shafranov solution.",
            "full_path": "equilibrium/time_slice(itime)/convergence/delta_relative",
        },
        'equilibrium.time_slice[:].convergence.delta_relative.value': {
            "data_type": "FLT_0D",
            "documentation": "Error in the Grad-Shafranov solution measured by the average " "deviation between Del* psi and R J_t.",
            "full_path": "equilibrium/time_slice(itime)/convergence/delta_relative/value",
        },
        'equilibrium.time_slice[:].constraints.total_chi_squared': {
            "data_type": "FLT_0D",
            "documentation": "A sum of the chi squared values for all measurements " "used to constrain the equilibrium.",
...
class OMFITgeqdsk(SortedDict, OMFITascii):
    ...
    def from_uda_epm(self, shot=99999, time=0.0, device='MAST'):
        ...
        self['BCENTR'] = _bVac.data[tind_Bt] / spec['R0']
        self['CURRENT'] = _cpasma.data[tind_sigBp]
        self['RMAXIS'] = _axisr.data[tind_xpt]
        self['ZMAXIS'] = _axisz.data[tind_xpt]
        self['SIMAG'] = _psi_axis.data[tind_ax]
...
class OMFITmeqdsk(OMFITnc):
    ...
    def to_omas(self, ods=None, time_index=0, time_index_efit=0):
        ...
        with omas_environment(ods, cocosio=1):
            ...
            conv['delta_relative.value'] = self['cerror']['data'][time_index_efit, i - 1]
