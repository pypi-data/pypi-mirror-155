    ...
    [
        ...
        (
            ...
            Examples(
                positives=collections.OrderedDict(
                    [
                        ("date_time_stamp_with_UTC", "2022-04-01T01:02:03Z"),
                        (
                            "date_time_stamp_with_positive_offset",
                            "2022-04-01T01:02:03+02:00",
                        ),
                        (
                            "date_time_stamp_with_zero_offset",
                            "2022-04-01T01:02:03+00:00",
                        ),
                        (
                            "date_time_stamp_with_negative_offset",
                            "2022-04-01T01:02:03-02:00",
                        ),
                        (
                            "date_time_stamp_with_long_fractional_seconds",
                            "2022-04-01T01:02:03.0123456789Z",
                        ),
                        (
                            "date_time_stamp_with_large_positive_year",
                            "12345678901234567890123456789012345678901234567890-04-01T01:02:03Z",
                        ),
                        (
                            "date_time_stamp_with_large_negative_year",
                            "-12345678901234567890123456789012345678901234567890-04-01T01:02:03Z",
                        ),
                        ...
                        ("fuzzed_04", "-0911-11-21T24:00:00Z"),
                        ("fuzzed_05", "-0652-03-04T16:04:58.1314:00"),
                        ("fuzzed_06", "-7000-01-01T00:00:00Z"),
                        ("fuzzed_07", "0371-08-25T20:39:03+07:32"),
                        ("fuzzed_08", "-32857713-08-17T22:43:13.496+09:17"),
                        ("fuzzed_09", "-0911-11-20T09:31:15+02:41"),
                        ("fuzzed_10", "-60601-01-10T24:00:00.000000+10:25"),
                    ]
                ),
                negatives=collections.OrderedDict(
                    [
                        ...
                        ("non_existing_february_29th", "2011-02-29T01:02:03Z"),
                        (
                            "date_time_stamp_with_invalid_positive_offset",
                            "2022-04-01T01:02:03+15:00",
                        ),
                        (
                            "date_time_stamp_with_invalid_negative_offset",
                            "2022-04-01T01:02:03-15:00",
                        ),
                        (
                            "date_time_stamp_with_seconds_in_offset",
                            "2022-04-01T01:02:03+02:00:12",
                        ),
                        ("without_seconds", "2022-04-01T01:02Z"),
                        ("without_minutes", "2022-04-01T01Z"),
                        (
                            "date_time_stamp_with_unexpected_suffix",
                            "2022-04-01T01:02:03Z-unexpected-suffix",
                        ),
                        (
        ...
        (
            ...
            Examples(
                positives=collections.OrderedDict(
                    [
                        ("days_hours_minutes_seconds", "P3DT10H30M1.1S"),
                        ("negative_duration", "-P120DT10H30M"),
                        (
                            "many_many_days_hours_minutes",
                            "P12345678901234567890DT12345678901234567890H12345678901234567890M",
                        ),
                        (
                            "long_fractional_seconds",
                            "P3DT10H30M1.12345678901234567890123456789012345678901234567890S",
                        ),
                        ("fuzzed_01", "-P35536DT31.2640S"),
                        ("fuzzed_02", "-P0DT614M700036S"),
                        ("fuzzed_03", "-P0D"),
                        ("fuzzed_04", "-P56884DT281S"),
                        ("fuzzed_05", "-P1935170748DT98672278009473.2S"),
                        ("fuzzed_06", "P530901586DT1S"),
                        ("fuzzed_07", "-P0DT6144M700036S"),
                        ("fuzzed_08", "-PT007778730527649M69922170.015647S"),
                        ("fuzzed_09", "PT45.5513984S"),
                        ("fuzzed_10", "-PT26851H45065053.90060711499186S"),
                    ]
                ),
                negatives=collections.OrderedDict(
                    [
            ...
            Examples(
                positives=collections.OrderedDict(
                    [
                        ...
                        ("year_month", "P1Y2M"),
                        ("only_month", "P2M"),
                        ("negative_duration", "-P1Y2M"),
                        ("fuzzed_01", "P72616Y2M"),
                        ("fuzzed_02", "P526Y5M"),
                        ("fuzzed_03", "-P33Y"),
                        ("fuzzed_04", "-P001Y452439M"),
                        ("fuzzed_05", "P44M"),
                        ("fuzzed_06", "-P547M"),
                        ("fuzzed_07", "P019Y"),
                        ("fuzzed_08", "P929Y"),
                        ("fuzzed_09", "-P03414388Y"),
                        ("fuzzed_10", "-P10Y"),
                    ]
                ),
                negatives=collections.OrderedDict(
