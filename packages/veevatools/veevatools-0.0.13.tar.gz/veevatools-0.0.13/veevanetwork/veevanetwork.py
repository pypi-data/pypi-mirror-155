        ...
        if api.keys().__contains__('request'):
            ...
            if api['request'].keys().__contains__('url'):
                ...
                if api['request']['url'].keys().__contains__('raw'):
                    ...
                    result['api_url'] = self.sub_request_params(api['request']['url']['raw']) ### Updating Result API URL
                    request_params['url'] = self.sub_request_params(api['request']['url']['raw']) ### Updating Request URL
                else:
