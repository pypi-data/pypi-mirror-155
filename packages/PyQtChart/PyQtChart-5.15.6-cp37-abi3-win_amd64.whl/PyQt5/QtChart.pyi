...
class QAbstractAxis(QtCore.QObject):
    ...
    class AxisTypes(PyQt5.sip.simplewrapper):
...
class QChart(QtWidgets.QGraphicsWidget):
    ...
    class AnimationOptions(PyQt5.sip.simplewrapper):
...
class QChartView(QtWidgets.QGraphicsView):
    ...
    class RubberBands(PyQt5.sip.simplewrapper):
...
class QPolarChart('QChart'):
    ...
    class PolarOrientations(PyQt5.sip.simplewrapper):
