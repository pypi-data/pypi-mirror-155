...
class indice:
    ...
    def layer_stack(self, start_date, end_date, cloud_threshold, data_days_interval, indice_name='ndvi', shp_file=None, bbox=None):
        ...
        for _key in _dates:
            ...
            write_raster(merged_b8, ndvi_arr, ndvi_file_path)
            del merged_b8
            del ndvi_arr
