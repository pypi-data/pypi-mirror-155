...
from elma.exceptions.elma_api_exception import ElmaApiException
from elma.models.auth.auth_result import AuthResult
from elma.models.data.data import Data
from elma.models.start_process.StartProcess import StartProcess
...
class ElmaApiWebClient:
    ...
    @staticmethod
    def init_with_auth_from_properties(config_file_name: str = None, config_file_absolute_path: str = None, properties: dict = None):
        if properties is None:
            properties = {}
            path: str
            if config_file_absolute_path is None:
                from pathology.path import Path
                dir = Path.script_dir().parent
                path = f'{dir}/{config_file_name}'
            else:
                path = config_file_absolute_path
