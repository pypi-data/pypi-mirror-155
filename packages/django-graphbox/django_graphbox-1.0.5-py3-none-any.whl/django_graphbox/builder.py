...
class SchemaBuilder:
    ...
    def add_model(self, model, exclude_fields=(), pagination_length=0, external_filters=[], internal_filters=[], filters_opeator=Q.AND, access_group=None, access_by_operation={}, validators_by_operation={}, internal_field_resolvers={}, exclude_fields_by_operation={}, save_as_password=[]):
