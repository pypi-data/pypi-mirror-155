...
class ClusterDefaultConfig(object):
    ...
    def __init__(self, cluster_network_cidr=None, cluster_network_host_prefix=None, inactive_deletion_hours=None, service_network_cidr=None, ntp_source=None):  # noqa: E501
