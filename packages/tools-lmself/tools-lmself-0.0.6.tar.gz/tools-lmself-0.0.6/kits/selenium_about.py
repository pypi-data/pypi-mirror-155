...
class get_selenium:
    ...
    @staticmethod
    def selenium_screenshot2pic(url, pic_name, size=(1920, 1080), pic_savepath=fr'pics', isMobile=False, mobileModel=None, showPosition=(0, 0), delay=3, log=False, chromedriverPath=r'./chromedriver.exe'):
        """
        selenium 浏览器截图
        :param url: 截图地址
        :param pic_name: 截图名称
