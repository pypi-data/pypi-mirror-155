...
def anim_transforms_to_deltas():
    ''' Convert object animation for normal transforms to delta transforms :file: startup/bl_operators/object.py\:765 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$765> _
...
def hide_render_clear_all():
    ''' Reveal all render objects by setting the hide render flag :file: startup/bl_operators/object.py\:672 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$672> _
...
def instance_offset_from_cursor():
    ''' Set offset used for collection instances based on cursor position :file: startup/bl_operators/object.py\:850 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$850> _
...
def instance_offset_from_object():
    ''' Set offset used for collection instances based on the active object position :file: startup/bl_operators/object.py\:1038 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$1038> _
...
def instance_offset_to_cursor():
    ''' Set cursor position to the offset used for collection instances :file: startup/bl_operators/object.py\:1021 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$1021> _
...
def isolate_type_render():
    ''' Hide unselected render objects of same type as active by setting the hide render flag :file: startup/bl_operators/object.py\:652 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$652> _
...
def lod_by_name():
    ''' Add levels of detail to this object based on object names :file: startup/bl_operators/object.py\:1173 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$1173> _
...
def lod_clear_all():
    ''' Remove all levels of detail from this object :file: startup/bl_operators/object.py\:1223 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$1223> _
...
def make_dupli_face():
    ''' Convert objects into instanced faces :file: startup/bl_operators/object.py\:640 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$640> _
