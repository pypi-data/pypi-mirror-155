...
class TypedKumaTrafficPermission:
    def __init__(
        ...
        *,
        ...
        destination_label: typing.Optional[builtins.str] = None,
    ) -> None:
        '''
        :param destination: 
        :param mesh: 
        ...
        if destination_label is not None:
            self._values["destination_label"] = destination_label
    ...
    @builtins.property
    def destination_label(self) -> typing.Optional[builtins.str]:
        result = self._values.get("destination_label")
        return typing.cast(typing.Optional[builtins.str], result)
