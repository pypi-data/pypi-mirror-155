...
LastEditTime: 2022-06-14 11:35:11
LastEditors: BDFD
Description: 
    ...
    if n<nmin:
        ...
        if i2==2:  
            ...
            if n>=nlC2:
                ...
                data6 += (('Chi-Squared 检验值','无 (因为样本容量小于'+str(nlC2)+')','无'),)
            # print('')#20220310
        ...
        plt.close("all")
        # return plot_url
    return plot_url, note1, note2, note3, data3, note4, data4, note5, data5, data6, heading1, heading2, ending