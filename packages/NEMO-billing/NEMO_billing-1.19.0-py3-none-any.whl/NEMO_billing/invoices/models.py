...
from NEMO.models import Customization, Project, User
...
class Invoice(models.Model):
    ...
    def filename_for_zip(self):
        ...
        account_name = slugify(self.project_details.project.account.name)
        return f"{account_name}/{name}-{year}-{month}-{slugify(self.invoice_number)}" + ext
