...
def anim_transforms_to_deltas():
    ''' Convert object animation for normal transforms to delta transforms :file: startup/bl_operators/object.py\:764 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$764> _
...
def hide_render_clear_all():
    ''' Reveal all render objects by setting the hide render flag :file: startup/bl_operators/object.py\:671 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$671> _
...
def instance_offset_from_cursor():
    ''' Set offset used for collection instances based on cursor position :file: startup/bl_operators/object.py\:849 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$849> _
...
def instance_offset_from_object():
    ''' Set offset used for collection instances based on the active object position :file: startup/bl_operators/object.py\:881 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$881> _
...
def instance_offset_to_cursor():
    ''' Set cursor position to the offset used for collection instances :file: startup/bl_operators/object.py\:864 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$864> _
...
def isolate_type_render():
    ''' Hide unselected render objects of same type as active by setting the hide render flag :file: startup/bl_operators/object.py\:651 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$651> _
...
def make_dupli_face():
    ''' Convert objects into instanced faces :file: startup/bl_operators/object.py\:639 <https://developer.blender.org/diffusion/B/browse/master/release/scripts/startup/bl_operators/object.py$639> _
