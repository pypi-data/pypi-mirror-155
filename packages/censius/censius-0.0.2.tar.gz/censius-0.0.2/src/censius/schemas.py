from censius import ExplanationType, ModelType , DatasetType 
...
register_dataset_schema = {
    ...
    "required": ["name", "project_id", "features","type"]
      ...
      "training_data": {
         ...
         "properties": {
            "production": {
               ...
               "required":["start_time"],
                "oneOf":[{"required":["end_time"]},{"required":["window_size"]}]
            },
            "new": {
               "type": "integer"
            }
         },
          "anyOf":[{"required":["production"]},{"required":["new"]}]
      }
   },
   "required": [
      "model_id",
