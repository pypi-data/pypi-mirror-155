...
def Start(builder):
    return ConversionMetadataStart(builder)
...
def AddEnvironment(builder, environment):
    return ConversionMetadataAddEnvironment(builder, environment)
...
def AddOptions(builder, options):
    return ConversionMetadataAddOptions(builder, options)
def ConversionMetadataEnd(builder): return builder.EndObject()
def End(builder):
    return ConversionMetadataEnd(builder)
try:
...
def Start(builder):
    return ConversionOptionsStart(builder)
...
def AddModelOptimizationModes(builder, modelOptimizationModes):
    return ConversionOptionsAddModelOptimizationModes(builder, modelOptimizationModes)
def ConversionOptionsStartModelOptimizationModesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartModelOptimizationModesVector(builder, numElems):
    return ConversionOptionsStartModelOptimizationModesVector(builder, numElems)
def ConversionOptionsAddAllowCustomOps(builder, allowCustomOps): builder.PrependBoolSlot(1, allowCustomOps, 0)
def AddAllowCustomOps(builder, allowCustomOps):
    return ConversionOptionsAddAllowCustomOps(builder, allowCustomOps)
def ConversionOptionsAddEnableSelectTfOps(builder, enableSelectTfOps): builder.PrependBoolSlot(2, enableSelectTfOps, 0)
def AddEnableSelectTfOps(builder, enableSelectTfOps):
    return ConversionOptionsAddEnableSelectTfOps(builder, enableSelectTfOps)
def ConversionOptionsAddForceSelectTfOps(builder, forceSelectTfOps): builder.PrependBoolSlot(3, forceSelectTfOps, 0)
def AddForceSelectTfOps(builder, forceSelectTfOps):
    return ConversionOptionsAddForceSelectTfOps(builder, forceSelectTfOps)
...
def AddSparsityBlockSizes(builder, sparsityBlockSizes):
    return ConversionOptionsAddSparsityBlockSizes(builder, sparsityBlockSizes)
def ConversionOptionsStartSparsityBlockSizesVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartSparsityBlockSizesVector(builder, numElems):
    return ConversionOptionsStartSparsityBlockSizesVector(builder, numElems)
def ConversionOptionsEnd(builder): return builder.EndObject()
def End(builder):
    return ConversionOptionsEnd(builder)
try:
...
def Start(builder):
    return EnvironmentStart(builder)
...
def AddTensorflowVersion(builder, tensorflowVersion):
    return EnvironmentAddTensorflowVersion(builder, tensorflowVersion)
...
def Start(builder):
    return SparsityBlockSizeStart(builder)
