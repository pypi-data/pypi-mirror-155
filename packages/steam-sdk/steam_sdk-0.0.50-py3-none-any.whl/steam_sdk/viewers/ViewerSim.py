...
from steam_sdk.parsers.ParserMat import getSpecificSignalMAT
...
class ViewerSim:
    ...
    def read_simulationSignals(self):
        ...
        if self.file_type == 'mat':
            self.simulationSignalsToPlot = getSpecificSignalMAT(self.path_sim, self.model_name, self.simNumber, self.list_Signals)
