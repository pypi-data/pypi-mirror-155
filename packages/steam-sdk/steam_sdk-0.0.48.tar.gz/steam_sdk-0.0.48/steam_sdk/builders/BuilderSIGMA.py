...
class BuilderSIGMA:
    ...
    def __init__(self, input_model_data: DataModelMagnet = None, input_roxie_data: dR.APIdata = None,
        ...
        self.roxie_data: dR.APIdata = input_roxie_data
...
if __name__ == "__main__":
    ...
    magnet_name = 'MQY_2in1'  #'MBH_2in1'  #'MQXA'  #'MBX'  #'MQXB'   # 'MQXF_V2'  #
