...
def _get_batch_materialization_plan_for_aggregate_feature_view(
    ...
    spark_df = _possibly_apply_feature_time_limits(spark, df, feature_data_time_limits, timestamp_key)
...
def _materialize_interval_for_temporal_feature_view(
    ...
    tile_df = _possibly_apply_feature_time_limits(spark, tile_df, feature_data_time_limits, timestamp_key)
