...
_FILE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='size', full_name='machinetalk.File.size', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_dir', full_name='machinetalk.File.is_dir', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_modified', full_name='machinetalk.File.last_modified', index=5,
...
_FILESERVICEDATA = _descriptor.Descriptor(
  name='FileServiceData',
  full_name='machinetalk.FileServiceData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='files', full_name='machinetalk.FileServiceData.files', index=0,
...
_FILESERVICEDATA.fields_by_name['files'].message_type = _FILE
...
DESCRIPTOR.message_types_by_name['FileServiceData'] = _FILESERVICEDATA
...
FileServiceData = _reflection.GeneratedProtocolMessageType('FileServiceData', (_message.Message,), dict(
  DESCRIPTOR = _FILESERVICEDATA,
  __module__ = 'machinetalk.protobuf.config_pb2'
  # @@protoc_insertion_point(class_scope:machinetalk.FileServiceData)
  ))
_sym_db.RegisterMessage(FileServiceData)
