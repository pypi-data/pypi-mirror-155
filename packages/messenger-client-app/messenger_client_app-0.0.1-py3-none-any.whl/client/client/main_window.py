...
class ClientMainWindow(QMainWindow):
    ...
    # A function that establishes an active interlocutor
    ...
    # Function updating the contact sheet
    ...
    # The function of adding a contact
    ...
    # The add handler function informs the server, updates the table and the contact list
    def add_contact_action(self, item):
        new_contact = item.selector.currentText()
        self.add_contact(new_contact)
        item.close()

    # A function that adds a contact to the databases
    ...
    # The contact deletion handler function, reports to the server, updates the contact table
