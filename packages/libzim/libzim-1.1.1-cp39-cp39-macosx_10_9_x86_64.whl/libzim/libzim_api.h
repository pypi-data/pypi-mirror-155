...
static uint64_t (*__pyx_api_f_6libzim_int_cy_call_fct)(PyObject *, std::string, std::string *) = 0;
...
static int import_libzim(void) {
  ...
  if (__Pyx_ImportFunction(module, "int_cy_call_fct", (void (**)(void))&__pyx_api_f_6libzim_int_cy_call_fct, "uint64_t (PyObject *, std::string, std::string *)") < 0) goto bad;
