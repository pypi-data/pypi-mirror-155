...
class Template:
    ...
    def getContent(class_, c):
        ...
        r = '<div class="%s">%s</div>' % (class_.getCssFor('content', c),
    ...
    def showConnect(class_, c):
        ...
        return c.isAnon and c.cfg.discreetLogin and \
               not c._px_.isHome(c, orPublic=False)
    ...
    pxBurger = Px('''
     ...
     css='.burger { cursor:pointer; margin:|burgerMargin| }')
