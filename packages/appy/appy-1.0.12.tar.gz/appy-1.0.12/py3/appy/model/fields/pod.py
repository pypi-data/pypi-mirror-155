...
class Pod(Field):
    ...
    class Layouts(Layouts):
        ...
        # Inline layout
        inline = Layouts(view=Layout('f', width=None,
    ...
    pxSelector = Px('''
     <select var="single=field.selectorIsSingle(_ctx_)"
             ...
             onmousedown=":'clickPodIcon(this, event)' if single else ''"
    ...
    view = cell = buttons = Px('''
     ...
     css='''
      ...
      .mpod { gap:0.1em }
      .tpod select { margin:0; font-size:70% }
     ...
     js='''
      ...
      clickPodIcon = function(select, event) {
        getPodIcon(select).click();
