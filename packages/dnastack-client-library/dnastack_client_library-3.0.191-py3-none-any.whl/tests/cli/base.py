...
class CliTestCase(ReversibleTestCase, BaseTestCase):
    ...
    def _invoke(self, *cli_blocks: str, envs: Optional[Dict[str, str]] = None, timeout: Optional[int] = None) -> Result:
        test_envs = {
    ...
    def invoke(self,
        ...
        result = self._invoke(*cli_blocks, envs=envs, timeout=timeout)
