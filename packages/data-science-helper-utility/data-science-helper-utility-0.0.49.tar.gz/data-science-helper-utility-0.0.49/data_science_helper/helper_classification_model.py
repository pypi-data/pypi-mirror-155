...
def get_result_df(KPIs_list):
    ...
    for idx, result  in enumerate(KPIs_list):
        ...
        t_train_class_1 = result[5]
        
        Ks = result[6]
        umbral_opt = result[7]
        Ks_opt = result[8]
        result_rd = [mr,mod,t_train,t_train_class_1,t_test,t_train_class_1]+[round(num, 3) for num in list(Ks)]+[umbral_opt]+[round(num_opt, 3) for num_opt in list(Ks_opt)]
