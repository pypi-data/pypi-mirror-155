...
def detect_community_brokers(nodes, edges):
    ...
    nodes = nodes_for_calculation.merge(community_brokers_list, on="id", how="outer")
    ...
    nodes_with_characteristics = nodes_for_calculation.merge(community_brokers_list_count, on="id", how="outer")
