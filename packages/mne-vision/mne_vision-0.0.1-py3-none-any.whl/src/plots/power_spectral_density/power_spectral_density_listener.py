...
class powerSpectralDensityListener(ABC):
    """
    Listener doing the connection between the controller and the view for computing the power spectral density on the dataset.
