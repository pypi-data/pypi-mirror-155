...
class compute_elastic_strain_1(Operator):
    ...
    global coordinates.Get the 1st principal component.
    ...
    >>> op = dpf.operators.result.compute_elastic_strain_1()
    ...
    def __init__(
        ...
        super().__init__(name="compute_elastic_strain_1", config=config, server=server)
        self._inputs = InputsComputeElasticStrain1(self)
        self._outputs = OutputsComputeElasticStrain1(self)
    ...
    def _spec():
        description = """Computes the strain from a displacement field. Only some 3-D elements
            ...
            All coordinates are global coordinates.Get the 1st
            principal component."""
        spec = Specification(
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="compute_elastic_strain_1", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsComputeElasticStrain1
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsComputeElasticStrain1
        """
        return super().outputs


class InputsComputeElasticStrain1(_Inputs):
    """Intermediate class used to connect user inputs to
    compute_elastic_strain_1 operator.
...
class OutputsComputeElasticStrain1(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_elastic_strain_1._spec().outputs, op)
        self._fields_container = Output(
            compute_elastic_strain_1._spec().output_pin(0), 0, op
        )
