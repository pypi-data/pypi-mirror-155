...
class compute_elastic_strain_Z(Operator):
    ...
    global coordinates.Get the ZZ normal component (22 component).
    ...
    >>> op = dpf.operators.result.compute_elastic_strain_Z()
    ...
    def __init__(
        ...
        super().__init__(name="compute_elastic_strain_Z", config=config, server=server)
        self._inputs = InputsComputeElasticStrainZ(self)
        self._outputs = OutputsComputeElasticStrainZ(self)
    ...
    def _spec():
        description = """Computes the strain from a displacement field. Only some 3-D elements
            ...
            All coordinates are global coordinates.Get the ZZ normal
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="compute_elastic_strain_Z", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsComputeElasticStrainZ
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsComputeElasticStrainZ
        """
        return super().outputs


class InputsComputeElasticStrainZ(_Inputs):
    """Intermediate class used to connect user inputs to
    compute_elastic_strain_Z operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_elastic_strain_Z._spec().inputs, op)
        self._time_scoping = Input(
            compute_elastic_strain_Z._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._scoping = Input(compute_elastic_strain_Z._spec().input_pin(1), 1, op, -1)
        self._inputs.append(self._scoping)
        self._streams_container = Input(
            compute_elastic_strain_Z._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources = Input(
            compute_elastic_strain_Z._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._extrapolate = Input(
            compute_elastic_strain_Z._spec().input_pin(5), 5, op, -1
        )
        self._inputs.append(self._extrapolate)
        self._nonlinear = Input(
            compute_elastic_strain_Z._spec().input_pin(6), 6, op, -1
        )
        self._inputs.append(self._nonlinear)
        self._abstract_meshed_region = Input(
            compute_elastic_strain_Z._spec().input_pin(7), 7, op, -1
        )
        self._inputs.append(self._abstract_meshed_region)
        self._requested_location = Input(
            compute_elastic_strain_Z._spec().input_pin(9), 9, op, -1
        )
        self._inputs.append(self._requested_location)
        self._displacement = Input(
            compute_elastic_strain_Z._spec().input_pin(10), 10, op, -1
        )
...
class OutputsComputeElasticStrainZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(compute_elastic_strain_Z._spec().outputs, op)
        self._fields_container = Output(
            compute_elastic_strain_Z._spec().output_pin(0), 0, op
        )
