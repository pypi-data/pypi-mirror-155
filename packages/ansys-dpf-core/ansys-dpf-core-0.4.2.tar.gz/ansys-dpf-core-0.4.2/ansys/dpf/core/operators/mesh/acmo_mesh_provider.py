...
class acmo_mesh_provider(Operator):
    ...
    def __init__(
        ...
        super().__init__(name="acmo::acmo::MeshProvider", config=config, server=server)
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="acmo::acmo::MeshProvider", server=server)
...
class InputsAcmoMeshProvider(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._read_cyclic = Input(acmo_mesh_provider._spec().input_pin(14), 14, op, -1)
...
class OutputsAcmoMeshProvider(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh = Output(acmo_mesh_provider._spec().output_pin(0), 0, op)
