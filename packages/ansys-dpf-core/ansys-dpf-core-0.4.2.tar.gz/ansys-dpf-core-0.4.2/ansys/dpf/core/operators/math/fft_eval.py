...
class fft_eval(Operator):
    """Evaluate the fast fourier transforms at a given set of fields.
      ...
      >>> op = dpf.operators.math.fft_eval(field_t=my_field_t,time_scoping=my_time_scoping)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Evaluate the fast fourier transforms at a given set of fields.""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "field_t", type_names=["field"], optional=False, document="""field of values to evaluate"""), 
...
class InputsFftEval(_Inputs):
    ...
    def field_t(self):
        ...
        - pindoc: field of values to evaluate
