...
class nodal_averaged_plastic_strains(Operator):
    """Read nodal averaged plastic strains as averaged nodal result from rst
    file.
    ...
    @staticmethod
    def _spec():
        description = """Read nodal averaged plastic strains as averaged nodal result from rst
            file."""
        spec = Specification(
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="mapdl::rst::NPPL", server=server)
...
class InputsNodalAveragedPlasticStrains(_Inputs):
    ...
    nodal_averaged_plastic_strains operator.
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping = Input(
            nodal_averaged_plastic_strains._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping = Input(
            nodal_averaged_plastic_strains._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._fields_container = Input(
            nodal_averaged_plastic_strains._spec().input_pin(2), 2, op, -1
        )
        self._inputs.append(self._fields_container)
        self._streams_container = Input(
            nodal_averaged_plastic_strains._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources = Input(
            nodal_averaged_plastic_strains._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._mesh = Input(
            nodal_averaged_plastic_strains._spec().input_pin(7), 7, op, -1
        )
...
class OutputsNodalAveragedPlasticStrains(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container = Output(
            nodal_averaged_plastic_strains._spec().output_pin(0), 0, op
        )
