...
class compute_elastic_strain_X(Operator):
    ...
    global coordinates.Get the XX normal component (00 component).
    ...
    >>> op = dpf.operators.result.compute_elastic_strain_X()
    ...
    def __init__(
        ...
        super().__init__(name="compute_elastic_strain_X", config=config, server=server)
        self._inputs = InputsComputeElasticStrainX(self)
        self._outputs = OutputsComputeElasticStrainX(self)
    ...
    def _spec():
        description = """Computes the strain from a displacement field. Only some 3-D elements
            ...
            All coordinates are global coordinates.Get the XX normal
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="compute_elastic_strain_X", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsComputeElasticStrainX
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsComputeElasticStrainX
        """
        return super().outputs


class InputsComputeElasticStrainX(_Inputs):
    """Intermediate class used to connect user inputs to
    compute_elastic_strain_X operator.
...
class OutputsComputeElasticStrainX(_Outputs):
