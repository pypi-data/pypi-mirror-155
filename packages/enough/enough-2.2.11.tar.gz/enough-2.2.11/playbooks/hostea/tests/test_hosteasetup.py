...
def test_hostea_setup(gitea_hostname, woodpecker_hostname, password, certs):
...
def test_hostea_woodpecker(gitea_hostname, woodpecker_hostname, password, certs):
    #
...
def test_hostea_run(gitea_hostname, woodpecker_hostname, password, certs):
    username = "testuserc"
    userpassword = "thepassword123"
    project = "testproject"
...
def test_gitea_main(gitea_hostname, woodpecker_hostname, password, certs):
    # Must be in woodpecker_admins at hostea/inventory/group_vars/gitea-service-group.yml
    username = "testusera"
    userpassword = "thepassword123"
    project = "testproject"
