...
from validation.geo_info_validator import PostalCode
from validation.common_validator import EmailValidator, PhoneValidator, StringValidator

class GeoInfo(ComplexJsonSerializer):
...
class Customer(ComplexJsonSerializer):
