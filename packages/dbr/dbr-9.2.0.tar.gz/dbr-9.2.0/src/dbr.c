...
static PyObject * DecodeBufferManually(PyObject * obj, PyObject *args)
{
    ...
    int ret = DBR_DecodeBuffer(self->hBarcode, barcodeBuffer, width, height, stride, imagePixelFormat, templateName);
...
static PyObject * StartVideoMode(PyObject *obj, PyObject *args)
{
    ...
    char * templateName = NULL;
    if (!PyArg_ParseTuple(args, "OOs|OOO",&pyParameters, &textResultCallback, &templateName, &intermediateResultCallback, &errorCodeCallback, &pUserData))
    {
		Py_RETURN_NONE;
    }
