...
class VerificationKeyList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([VerificationKey],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """VerificationKeyList - a model defined in OpenAPI
        ...
        Args:
            ...
            objects ([VerificationKey]): Array of VerificationKey entities
