...
- dataRowComponent (string | dict; optional):
    An alias for the dataRowTemplate property specified in React.
    Accepts a custom component. Refer to Using a Custom Component for
    more information.

- dataRowRender (string; optional):
    An alias for the dataRowTemplate property specified in React.
    Accepts a rendering function. Refer to Using a Rendering Function
    for more information.

- dataRowTemplate (string | dict; optional):
