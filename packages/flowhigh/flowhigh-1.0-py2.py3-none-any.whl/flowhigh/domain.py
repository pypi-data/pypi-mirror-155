...
from flowhigh.util.generic_repr import generic_repr
...
class Node(ABC):
    ...
    def get_tables(self):
        return self.visitor.get_tables()

    def get_columns(self):
        return self.visitor.get_columns()

    def get_column_names(self):
        return self.visitor.get_column_names()

    def get_sort_columns(self):
        return self.visitor.get_sort_columns()

    def get_agg_columns(self):
        return self.visitor.get_agg_columns()

    def get_table_names(self):
        return self.visitor.get_table_names()

    def get_join_columns(self):
        return self.visitor.get_join_columns()

    def get_filter_column_operations(self):
        return self.visitor.get_filter_column_operations()

    def get_filter_columns(self):
        return self.visitor.get_filter_columns()

    def get_filter_operations(self):
        if isinstance(self, Attr):
            return self.visitor.get_filter_operations(self)
        return []
...
class ColumnMapping(dict):
    ...
    def as_dict(self):
        return {
            ...
            "input_expression": self['source'].get_attr_raw(),
            "input_alias": self['source'].get_attr_alias(),
