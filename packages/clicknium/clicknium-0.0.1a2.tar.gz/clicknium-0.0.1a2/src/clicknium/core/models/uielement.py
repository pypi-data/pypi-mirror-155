        ...
        """
            ...
            Parameters:
                ...
                input_method: the input method for the set text opeartion  
                    ...
                    keyboard-simulate-click: click(mouse emulator) the target element first and then input text through keyboard simulate
                    keyboard-simulate-setfocus: set focus on the target element first and then input text through keyboard simulate
