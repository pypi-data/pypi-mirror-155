...
class CoLinkStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RefreshToken = channel.unary_unary(
                ...
                request_serializer=colink__pb2.RefreshTokenRequest.SerializeToString,
        ...
        self.RequestCoreInfo = channel.unary_unary(
                '/colink.CoLink/RequestCoreInfo',
                request_serializer=colink__pb2.Empty.SerializeToString,
                response_deserializer=colink__pb2.CoreInfo.FromString,
                )
...
class CoLinkServicer(object):
    ...
    def RequestCoreInfo(self, request, context):
...
def add_CoLinkServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RefreshToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=colink__pb2.RefreshTokenRequest.FromString,
            ...
            'RequestCoreInfo': grpc.unary_unary_rpc_method_handler(
                    servicer.RequestCoreInfo,
                    request_deserializer=colink__pb2.Empty.FromString,
                    response_serializer=colink__pb2.CoreInfo.SerializeToString,
            ),
...
class CoLink(object):
    ...
    def RefreshToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/colink.CoLink/RefreshToken',
            colink__pb2.RefreshTokenRequest.SerializeToString,
    ...
    def RequestCoreInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/colink.CoLink/RequestCoreInfo',
            colink__pb2.Empty.SerializeToString,
            colink__pb2.CoreInfo.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
