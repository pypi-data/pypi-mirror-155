...
abs_path_VAE = os.path.join(script_dir, rel_path_encoder)
ENCODER_LOCATION = os.path.join(script_dir, rel_path_encoder)

class Timestamp2Vec_model(Model):
    def __init__(self):
        super(Timestamp2Vec_model, self).__init__()
