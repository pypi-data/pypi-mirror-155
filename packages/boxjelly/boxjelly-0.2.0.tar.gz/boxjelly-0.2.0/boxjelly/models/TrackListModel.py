...
class TrackListModel(QtCore.QAbstractListModel):
    ...
    EventsRole = QtCore.Qt.UserRole + 5  # List of track's boxes (None indicates no box at that frame)
    EventLabelsRole = QtCore.Qt.UserRole + 6  # List of strings for all event labels (e.g. ["fish", "fish"])
