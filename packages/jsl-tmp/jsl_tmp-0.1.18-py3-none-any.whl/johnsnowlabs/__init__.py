...
def start(
    ...
    from johnsnowlabs.auto_install.jsl_lib_resolvers import NlpLibResolver
    from johnsnowlabs.auto_install.jsl_lib_resolvers import HcLibResolver
    from johnsnowlabs.auto_install.jsl_lib_resolvers import OcrLibResolver
