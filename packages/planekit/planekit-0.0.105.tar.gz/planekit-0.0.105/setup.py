...
VERSION = "0.0.104"  # BURAYI AKLINIZDA TUTUN (Değiştirebilirsiniz)
long_description = ""
with open("README.md", "r", encoding="utf-8") as file:
    long_description = file.read()
required = []
required.append('pymavlink==2.4.29')
required.append('pyserial==3.5')
print(required)
setup(
    name='planekit',  # How you named your package folder (MyLib)
    ...
    author='Musa SEN',  # Adınızı soyadınız yazın
    author_email='m42@gmail.com',  # E-posta adresiniz
