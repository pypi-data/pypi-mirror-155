...
import random
from local_utils import make_random_name
...
if __name__ == '__main__':
    ft = FolderTools('/workspace/85_cluster/mnt/dataset/download/multi_face_extract/multi_face_extract_5w_1',
                     save_path='/workspace/85_cluster/mnt/dataset/download/multi_face_extract/multi_face_extract_5w_4')
    ft.extract_imgs_from_folder(img_num=50000, paste=True)
