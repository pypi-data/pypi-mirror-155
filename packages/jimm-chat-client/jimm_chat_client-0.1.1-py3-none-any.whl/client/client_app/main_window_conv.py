...
class Ui_MainClientWindow(object):
    def setupUi(self, MainClientWindow):
        ...
        self.list_contacts.setGeometry(QtCore.QRect(10, 20, 280, 411))
        ...
        self.btn_send.setGeometry(QtCore.QRect(610, 440, 131, 31))
        self.btn_send.setObjectName("btn_send")
        self.btn_clear = QtWidgets.QPushButton(self.centralwidget)
        self.btn_clear.setGeometry(QtCore.QRect(450, 440, 131, 31))
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "Chat application"))
