...
from .operations import AppsOperations, AzureRegionsOperations, CdfClustersOperations, CountriesOperations, CustomersOperations, DatabasesOperations, PowerOperations, TenantsOperations, UserOperations
...
class IgnosInternalApi(object):  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    """IgnosInternalApi.
