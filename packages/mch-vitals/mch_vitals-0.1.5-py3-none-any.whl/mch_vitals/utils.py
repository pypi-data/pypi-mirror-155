...
def spo2_estimation(ppg_green_940, ppg_red_600, timestamps, fps):
    ...
    * vp_940 is the heigh systolic peak for the green color
    ...
    if len(vp_600) > len(vp_940):
        vp_600 = vp_600[:len(vp_940)]
        m_600 = m_600[:len(vp_940)]
        # hr_600 = hr_600[:len(hr_940)]
    if len(vp_940) > len(vp_600):
        vp_940 = vp_940[:len(vp_600)]
        m_940 = m_940[:len(vp_600)]
        # hr_940 = hr_940[:len(hr_600)]
