...
from Artesian.Query._QueryParameters.QueryParameters import _FillCustomMasStrategy, _FillLatestStrategy, _NoFillStrategy, _NullFillStrategy
...
class MasQuery(_Query):
    ...
    def forMarketData(self, ids: List[int]) -> MasQuery:
        """ 
        ...
        return self
    def forFilterId(self, filterId: int) -> MasQuery:
        """ 
        ...
        return self
    def inTimeZone(self, tz: str) -> MasQuery:
        """ 
        ...
        return self
    def inAbsoluteDateRange(self, start: str, end: str) -> MasQuery:
        """ 
        ...
        return self
    def inRelativePeriodRange(self, pStart: str, pEnd: str) -> MasQuery:
        """ 
        ...
        return self
    def inRelativePeriod(self, extractionPeriod: str) -> MasQuery:
        """ 
        ...
        return self
    def inRelativeInterval(self, relativeInterval: RelativeInterval) -> MasQuery:
        """ 
        ...
        return self
    def forProducts(self, products: List[str]) -> MasQuery:
        """ 
        ...
        return self
    def withFillNull(self) -> MasQuery:
        """ 
        ...
        return self
    def withFillNone(self) -> MasQuery:
        """ 
            Optional filler strategy for the extraction.
        ...
        return self
    def withFillLatestValue(self, period: str) -> MasQuery:
        """ 
            Optional filler strategy for the extraction.
        ...
        return self
    def withFillCustomValue(self, **val) -> MasQuery:
        """ 
            Optional filler strategy for the extraction.
