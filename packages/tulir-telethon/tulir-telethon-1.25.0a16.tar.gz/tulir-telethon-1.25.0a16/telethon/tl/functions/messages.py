...
class ProlongWebViewRequest(TLRequest):
    CONSTRUCTOR_ID = 0xd22ad148
    SUBCLASS_OF_ID = 0xf5b399ac

    def __init__(self, peer: 'TypeInputPeer', bot: 'TypeInputUser', query_id: int, silent: Optional[bool]=None, reply_to_msg_id: Optional[int]=None):
        """
        :returns Bool: This type has no constructors.
        """
        self.peer = peer
    ...
    def _bytes(self):
        return b''.join((
            b'H\xd1*\xd2',
            struct.pack('<I', (0 if self.silent is None or self.silent is False else 32) | (0 if self.reply_to_msg_id is None or self.reply_to_msg_id is False else 1)),
            self.peer._bytes(),
            self.bot._bytes(),
    ...
    def from_reader(cls, reader):
        ...
        return cls(peer=_peer, bot=_bot, query_id=_query_id, silent=_silent, reply_to_msg_id=_reply_to_msg_id)
...
class RequestWebViewRequest(TLRequest):
    CONSTRUCTOR_ID = 0xfa04dff
    SUBCLASS_OF_ID = 0x93cea746

    def __init__(self, peer: 'TypeInputPeer', bot: 'TypeInputUser', from_bot_menu: Optional[bool]=None, silent: Optional[bool]=None, url: Optional[str]=None, start_param: Optional[str]=None, theme_params: Optional['TypeDataJSON']=None, reply_to_msg_id: Optional[int]=None):
        """
    ...
    def from_reader(cls, reader):
        ...
        if flags & 1:
            ...
            _reply_to_msg_id = None
        return cls(peer=_peer, bot=_bot, from_bot_menu=_from_bot_menu, silent=_silent, url=_url, start_param=_start_param, theme_params=_theme_params, reply_to_msg_id=_reply_to_msg_id)
