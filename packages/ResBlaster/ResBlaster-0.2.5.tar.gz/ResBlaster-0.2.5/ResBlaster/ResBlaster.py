...
def args_parse():
    ...
    parser.add_argument("-store_nucl_seq", default=False, action="store_true",
                        help='if save the nucleotide sequence of find ARGs on genome')
    parser.add_argument("-store_prot_seq", default=False, action="store_true",
                        help='if save the protein sequence of find ARGs on genome')
    ...
    if args.list:
        ...
        for file in os.listdir(input_path):
            ...
            if os.path.isfile(file_path):
                ...
                if args.store_nucl_seq:
                    Blaster.get_nucl_seq(result_dict, output_path)
                if args.store_prot_seq:
                    Blaster.get_prot_seq(result_dict, output_path)
