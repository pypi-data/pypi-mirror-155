...
class Sign03:
    ...
    def buy(self, df):
        con1 = (df['pb-1'] > self.params['pb_min'])
        con2 = (df['pb-1'] < self.params['pb_max'])
        con3 = (df['bbw-1'] > self.params['bbw_min'])
        con4 = (df['bbw-1'] < self.params['bbw_max'])
    ...
    def multi_buy_values(self, df):
        ...
        values = {
            ...
            'buy_pb__max' : pb_range[count1_length:],
    ...
    def multi_sell_values(self, df):
        ...
        values = {
            ...
            'sell_pb__max' : pb_range[count1_length:],
