...
def send_mail_with_attachment(file_attachment, receiver_mail, test_mail="matias@muvinai.com"):
    ...
    attachment = [{'content': file_str, 'name': file_attachment, 'type': 'application/pdf'}]
