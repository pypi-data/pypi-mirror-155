...
class G_ADV_POS(GrammaticalForms):
    name_en = "Adverbs Positive Degree"

    def count(self, doc):
        result = self.incidence(doc, attr_name='adverbs', attr_value="positive_adverb", pos_range='all')
        return result


class G_ADV_COMP(GrammaticalForms):
    name_en = "Adverbs Comparative Degree"

    def count(self, doc):
        result = self.incidence(doc, attr_name='adverbs', attr_value="comparative_adverb", pos_range='all')
        return result


class G_ADV_SUP(GrammaticalForms):
    name_en = "Adverbs Comparative Degree"

    def count(self, doc):
        result = self.incidence(doc, attr_name='adverbs', attr_value="superlative_adverb", pos_range='all')
        return result
