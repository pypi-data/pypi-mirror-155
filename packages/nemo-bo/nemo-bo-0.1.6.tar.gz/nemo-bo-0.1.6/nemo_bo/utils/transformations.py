...
class Transformations:
    ...
    def X_min_max_norm_cuda_run(
        self, X: np.ndarray, x_max: Union[List[Union[int, float]], np.ndarray], x_min: Union[List[Union[int, float]], np.ndarray]
    ) -> np.ndarray:
    ...
    def X_min_max_norm_cuda(
        X: np.ndarray, X_norm: np.ndarray, x_max: Union[List[Union[int, float]], np.ndarray], x_min: Union[List[Union[int, float]], np.ndarray]
    ) -> None:
    ...
    def X_inverse_min_max_norm_cuda_run(
        self, X_norm: np.ndarray, x_max: Union[List[Union[int, float]], np.ndarray], x_min: Union[List[Union[int, float]], np.ndarray]
    ) -> np.ndarray:
    ...
    def X_inverse_min_max_norm_cuda(
        X_norm: np.ndarray, X: np.ndarray, x_max: Union[List[Union[int, float]], np.ndarray], x_min: Union[List[Union[int, float]], np.ndarray]
    ):
    ...
    def X_standardisation_cuda_run(
        self, X: np.ndarray, X_mean: Union[List[Union[int, float]], np.ndarray], X_stddev: Union[List[Union[int, float]], np.ndarray]
    ) -> np.ndarray:
    ...
    def Y_standardisation_cuda_run(self, Y: np.ndarray, Y_mean: Union[int, float], Y_stddev: Union[int, float]) -> np.ndarray:
        if len(Y.shape) > 1:
            Y = Y.flatten()
