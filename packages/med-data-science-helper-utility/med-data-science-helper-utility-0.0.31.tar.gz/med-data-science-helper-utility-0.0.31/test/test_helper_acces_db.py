...
df_serv = hadb.get_df_servicios(anio=2020,macro_region="lima_metro_callao")





df_678 = hadb.get_siagie_por_anio(2020,macro_region="lima_metro_callao",desercion=True,  modalidad="EBR" , id_grado_list= [6,7,8] ,columns_n= ['ID_PERSONA','COD_MOD','ANEXO'])

print(df_678.columns)

c.Counter(df_678.D_REGION)

c.Counter(df_678[df_678.DESERCION_2020_2021==1].D_REGION)




df_678.groupby(['D_DREUGEL','D_REGION','DESERCION_2020_2021'],as_index=False)["DESERCION_2020_2021"].count()
