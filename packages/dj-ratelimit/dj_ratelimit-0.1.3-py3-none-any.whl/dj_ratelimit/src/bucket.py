...
def ratelimit(rate: Any = None, burst_limit: Any = None, key_fn: Any = lambda req: "", bucket: Any = None) -> Any:
...
class Bucket:
    ...
    def __init__(self, rate: str = DEFAULT_LEAK_RATE, burst_limit: int = DEFAULT_CAPACITY, key_fn: Any = lambda req: "") -> None:
