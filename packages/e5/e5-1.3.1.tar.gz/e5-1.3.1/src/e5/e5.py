...
from lib.e5_widgets import e5_MainScreen, e5_scrollview_menu, e5_scrollview_label, e5_button, e5_label, e5_side_by_side_buttons, e5_LoadDialog, e5_MessageBox, e5_textinput, e5_RecordEditScreen
from lib.e5_widgets import e5_DatagridScreen, e5_InfoScreen, e5_LogScreen, e5_CFGScreen, e5_INIScreen, e5_SettingsScreen
from lib.colorscheme import ColorScheme
from lib.misc import platform_name, restore_window_size_position, locate_file, filename_only
...
class E5App(App):
    ...
    def setup_logger(self):
        ...
        fh = logging.FileHandler(path.join(self.app_path, __program__ + '.log'))
