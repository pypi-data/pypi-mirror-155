...
- Development of **highly customizable scorecards** that adapt to the requirements of each user.

## Source code
Check out to the [GitHub](https://github.com/Guilliu/pyken) repository.
''',
)
