...
def two_way(operation, opposite=False, iterators=False, print_width=120, pprint=True):
    import warnings
...
def operator_check(left_argument, right_argument, show_failed=False, print_width=120, pprint=True):
    import warnings
    warnings.filterwarnings("ignore")
    failed = set()
    succeeded = set()
...
extended_builtins = ['Ellipsis', 'False', 'None', 'NotImplemented', 'True', 'abs', 'all', 'any',
                     ...
                     'dir', 'display', 'divmod', 'enumerate', 'eval', 'exec', 'execfile',
