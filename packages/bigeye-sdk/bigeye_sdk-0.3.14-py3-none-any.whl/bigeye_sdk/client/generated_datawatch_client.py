...
from bigeye_sdk.generated.com.torodata.models.generated import TableList, ColumnMetricProfileList, \
    ...
    GetDebugQueriesRequest, GetComparisonTableResponse, BulkResponse, BulkMetricOperation, WhereClause, MuteRequest
...
class GeneratedDatawatchClient(abc.ABC):
    ...
    def bulk_update_metrics(
        ...
        self._call_datawatch(Method.PUT, url=url, params=request.to_dict())
