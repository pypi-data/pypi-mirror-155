...
def write_token_file(tokfile, token_time, token, refresh_token, idToken):
...
def login_and_update_token_file(cognito_client_id, cognito_callback_url,
    ...
    write_token_file(tokfile, token_time, accessToken, refresh_token, idToken)
...
def renew_token(region, tokfile, refresh_token, client_id):
    ...
    try:
        ...
        idToken = authres['IdToken']        
        token_time = int(time.time())
        write_token_file(tokfile, token_time, token, refresh_token, idToken)
