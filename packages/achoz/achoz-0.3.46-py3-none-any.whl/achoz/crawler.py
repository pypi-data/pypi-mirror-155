...
def crawling():
    ...
    for row in rows:
        ...
        if not crawled_content:
            ...
            continue
        insert_statement = f"insert or ignore into crawled_data values ('{id}',{crawled_content.get('ctime')},{crawled_content.get('mtime')},{crawled_content.get('atime')},'{crawled_content.get('extrainfo')}','{crawled_content.get('mime')}','{crawled_content.get('ext')}','{crawled_content.get('content')}');"
        metadata_db.execute(insert_statement)
