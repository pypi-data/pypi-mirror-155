...
class DatameshPackageDisplay extends (react__WEBPACK_IMPORTED_MODULE_7___default().Component) {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_7___default().createElement("div", { className: 'datamesh-package-display' }, this.props.spec && (react__WEBPACK_IMPORTED_MODULE_7___default().createElement("div", null, this.props.spec.data.map(datasource => (
...
//# sourceMappingURL=lib_index_js.168658a39f12c5eeff54.js.map