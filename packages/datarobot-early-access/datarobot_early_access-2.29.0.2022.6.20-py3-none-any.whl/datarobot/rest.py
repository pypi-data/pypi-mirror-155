...
class RESTClientObject(requests.Session):
    ...
    @staticmethod
    def _make_user_agent_header(suffix=None):  # pylint: disable=missing-function-docstring
    ...
    def post(self, url, data=None, keep_attrs=None, **kwargs):  # pylint: disable=arguments-renamed
        if data:
...
def _http_message(response):  # pylint: disable=missing-function-docstring
...
def handle_http_error(response, **kwargs):  # pylint: disable=missing-function-docstring
