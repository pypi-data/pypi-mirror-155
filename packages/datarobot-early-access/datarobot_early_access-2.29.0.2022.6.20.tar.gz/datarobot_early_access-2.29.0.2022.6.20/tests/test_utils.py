...
def bar(arg1, arg2):  # pylint: disable=disallowed-name
    """
...
def foo(arg1, arg2):  # pylint: disable=disallowed-name
    """
    A dummy function to use for testing the deprecation mechanisms
...
def test_resource():
    ...
    with warns():
        open(__file__)  # pylint: disable=consider-using-with
...
class TestImports(unittest.TestCase):
    def test_rename(self):
        ...
        with self.assertRaises(ImportError):
            import datarobot_sdk  # noqa pylint: disable=import-error, unused-import, import-outside-toplevel
