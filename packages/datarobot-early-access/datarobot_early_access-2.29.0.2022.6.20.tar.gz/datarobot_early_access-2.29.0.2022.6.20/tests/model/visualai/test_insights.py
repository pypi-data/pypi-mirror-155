...
def test_image_embeddings(
    ...
    img0, img1 = ImageEmbedding.list(  # pylint: disable=unbalanced-tuple-unpacking
        project_id, model_id, "image"
    )
...
def test_image_activationmpas(
    ...
    img0, img1 = ImageActivationMap.list(  # pylint: disable=unbalanced-tuple-unpacking
        project_id, model_id, "image"
    )
