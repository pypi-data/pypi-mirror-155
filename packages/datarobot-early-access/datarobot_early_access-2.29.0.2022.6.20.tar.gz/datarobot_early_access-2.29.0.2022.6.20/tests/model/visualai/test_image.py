...
def test_get_sample_images(visualai_project, visualai_sample, project_url, project_id):
    ...
    img0, img1 = SampleImage.list(project_id, "image")  # pylint: disable=unbalanced-tuple-unpacking
...
def test_get_duplicate_images(visualai_project, visualai_duplicate, project_url, project_id):
    ...
    img0, img1 = DuplicateImage.list(  # pylint: disable=unbalanced-tuple-unpacking
        project_id, "image"
    )
