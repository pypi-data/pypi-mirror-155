...
class ProjectTestCase(SDKTestcase):
    ...
    def test_delete_project(self):
        ...
        project = Project("p-id")
        del_result = project.delete()  # pylint: disable=assignment-from-no-return
    ...
    def test_by_upload_file_closed(self):
        ...
        fd = open(path)  # pylint: disable=consider-using-with
        fd.close()
    ...
    def test_get_monotonicity_blueprints(self):
        ...
        for b in blueprint_resp:
            b.update(mono_config)
        responses.add(
            responses.GET,
            "https://host_name.com/projects/p-id/blueprints/",
            status=200,
