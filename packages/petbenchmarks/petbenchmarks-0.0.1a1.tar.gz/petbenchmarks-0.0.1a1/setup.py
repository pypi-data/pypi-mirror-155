...
setup(
    ...
    description='Convenient interface that provides structured representations of the PET dataset hosted on Huggingface and benchmarks to test approaches on',
