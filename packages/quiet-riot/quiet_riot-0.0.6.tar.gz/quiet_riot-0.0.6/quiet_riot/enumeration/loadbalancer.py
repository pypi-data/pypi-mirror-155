...
def threader(words,session):
    ...
    print('')
    print('If you have provided S3 bucket name then Scan results can be found in the S3 bucket, if any valid_scan_results were identified. Else Quiet-Riot has created S3 bucket name starting with quiet_riot-your account number.' )
    print("")
