...
def threader(words):
    ...
    print('')
    print('If you have provided S3 bucket name then Scan results can be found in the S3 bucket, if any valid_scan_results were identified. Else you can find vali_scan_result file in working directory')
    return results_file
