...
--scan_type              
What type of scan do you want to attempt? Enter the type of scan for example 1.accounts,2.root account,3.account footprint,4.roles,5.users
For scan type you have to provide the number from 1-5
...
First you have to install the package using pip command in command line. for e.g pip install quiet-riot==0.0.2

For help you can run the command python -m quiet_riot.main --help
