...
__version__ = "0.0.0.0.1b3"
__description__ = "Personal add-on extension to Pyrogram"
__copyright__ = "Copyright (C) 2022 Stark Bots <https://github.com/StarkBotsIndustries>"
__license__ = "GNU General Public License v3 or later (GPLv3+)"
__terms__ = f"MicroStark is free software and comes with ABSOLUTELY NO WARRANTY. \nLicensed under the terms of {__license__}."
