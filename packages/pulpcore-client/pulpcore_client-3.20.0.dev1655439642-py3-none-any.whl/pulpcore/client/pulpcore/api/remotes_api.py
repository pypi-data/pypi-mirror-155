...
class RemotesApi(object):
    ...
    def create(self, remote, **kwargs):  # noqa: E501
        """Create a remote  # noqa: E501
        ...
        >>> thread = api.create(remote, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param Remote remote: (required)
        ...
        return self.create_with_http_info(remote, **kwargs)  # noqa: E501

    def create_with_http_info(self, remote, **kwargs):  # noqa: E501
        """Create a remote  # noqa: E501

        A customized named ModelViewSet that knows how to register itself with the Pulp API router.  This viewset is discoverable by its name. \"Normal\" Django Models and Master/Detail models are supported by the ``register_with`` method.  Attributes:     lookup_field (str): The name of the field by which an object should be looked up, in         addition to any parent lookups if this ViewSet is nested. Defaults to 'pk'     endpoint_name (str): The name of the final path segment that should identify the ViewSet's         collection endpoint.     nest_prefix (str): Optional prefix under which this ViewSet should be nested. This must         correspond to the \"parent_prefix\" of a router with rest_framework_nested.NestedMixin.         None indicates this ViewSet should not be nested.     parent_lookup_kwargs (dict): Optional mapping of key names that would appear in self.kwargs         to django model filter expressions that can be used with the corresponding value from         self.kwargs, used only by a nested ViewSet to filter based on the parent object's         identity.     schema (DefaultSchema): The schema class to use by default in a viewset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_with_http_info(remote, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(RemoteResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('remote' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `remote` when calling `create`")  # noqa: E501
        ...
        if 'remote' in local_var_params:
            body_params = local_var_params['remote']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='RemoteResponse',  # noqa: E501
    ...
    def delete(self, remote_href, **kwargs):  # noqa: E501
        """Delete a remote  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete(remote_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str remote_href: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_with_http_info(remote_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, remote_href, **kwargs):  # noqa: E501
        """Delete a remote  # noqa: E501

        Trigger an asynchronous delete task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(remote_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `remote_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'remote_href' in local_var_params:
            path_params['remote_href'] = local_var_params['remote_href']  # noqa: E501
    ...
    def partial_update(self, remote_href, patched_remote, **kwargs):  # noqa: E501
        """Update a remote  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update(remote_href, patched_remote, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str remote_href: (required)
        :param PatchedRemote patched_remote: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.partial_update_with_http_info(remote_href, patched_remote, **kwargs)  # noqa: E501

    def partial_update_with_http_info(self, remote_href, patched_remote, **kwargs):  # noqa: E501
        """Update a remote  # noqa: E501

        Trigger an asynchronous partial update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.partial_update_with_http_info(remote_href, patched_remote, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `remote_href` when calling `partial_update`")  # noqa: E501
        # verify the required parameter 'patched_remote' is set
        if self.api_client.client_side_validation and ('patched_remote' not in local_var_params or  # noqa: E501
                                                        local_var_params['patched_remote'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `patched_remote` when calling `partial_update`")  # noqa: E501
        ...
        body_params = None
        if 'patched_remote' in local_var_params:
            body_params = local_var_params['patched_remote']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def read(self, remote_href, **kwargs):  # noqa: E501
        """Inspect a remote  # noqa: E501

        A customized named ModelViewSet that knows how to register itself with the Pulp API router.  This viewset is discoverable by its name. \"Normal\" Django Models and Master/Detail models are supported by the ``register_with`` method.  Attributes:     lookup_field (str): The name of the field by which an object should be looked up, in         addition to any parent lookups if this ViewSet is nested. Defaults to 'pk'     endpoint_name (str): The name of the final path segment that should identify the ViewSet's         collection endpoint.     nest_prefix (str): Optional prefix under which this ViewSet should be nested. This must         correspond to the \"parent_prefix\" of a router with rest_framework_nested.NestedMixin.         None indicates this ViewSet should not be nested.     parent_lookup_kwargs (dict): Optional mapping of key names that would appear in self.kwargs         to django model filter expressions that can be used with the corresponding value from         self.kwargs, used only by a nested ViewSet to filter based on the parent object's         identity.     schema (DefaultSchema): The schema class to use by default in a viewset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(remote_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(remote_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, remote_href, **kwargs):  # noqa: E501
        """Inspect a remote  # noqa: E501

        A customized named ModelViewSet that knows how to register itself with the Pulp API router.  This viewset is discoverable by its name. \"Normal\" Django Models and Master/Detail models are supported by the ``register_with`` method.  Attributes:     lookup_field (str): The name of the field by which an object should be looked up, in         addition to any parent lookups if this ViewSet is nested. Defaults to 'pk'     endpoint_name (str): The name of the final path segment that should identify the ViewSet's         collection endpoint.     nest_prefix (str): Optional prefix under which this ViewSet should be nested. This must         correspond to the \"parent_prefix\" of a router with rest_framework_nested.NestedMixin.         None indicates this ViewSet should not be nested.     parent_lookup_kwargs (dict): Optional mapping of key names that would appear in self.kwargs         to django model filter expressions that can be used with the corresponding value from         self.kwargs, used only by a nested ViewSet to filter based on the parent object's         identity.     schema (DefaultSchema): The schema class to use by default in a viewset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(remote_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `remote_href` when calling `read`")  # noqa: E501
    ...
    def update(self, remote_href, remote, **kwargs):  # noqa: E501
        """Update a remote  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update(remote_href, remote, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_with_http_info(remote_href, remote, **kwargs)  # noqa: E501

    def update_with_http_info(self, remote_href, remote, **kwargs):  # noqa: E501
        """Update a remote  # noqa: E501

        Trigger an asynchronous update task  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_with_http_info(remote_href, remote, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('remote_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['remote_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `remote_href` when calling `update`")  # noqa: E501
        # verify the required parameter 'remote' is set
        if self.api_client.client_side_validation and ('remote' not in local_var_params or  # noqa: E501
                                                        local_var_params['remote'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `remote` when calling `update`")  # noqa: E501
