...
class RepositoriesVersionsApi(object):
    ...
    def delete(self, repositories_repository_version_href, **kwargs):  # noqa: E501
        ...
        >>> thread = api.delete(repositories_repository_version_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str repositories_repository_version_href: (required)
        ...
        return self.delete_with_http_info(repositories_repository_version_href, **kwargs)  # noqa: E501

    def delete_with_http_info(self, repositories_repository_version_href, **kwargs):  # noqa: E501
        """Delete a repository version  # noqa: E501

        Trigger an asynchronous task to delete a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(repositories_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        all_params = [
            'repositories_repository_version_href'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        if self.api_client.client_side_validation and ('repositories_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['repositories_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `repositories_repository_version_href` when calling `delete`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'repositories_repository_version_href' in local_var_params:
            path_params['repositories_repository_version_href'] = local_var_params['repositories_repository_version_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{repositories_repository_version_href}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list(self, repository_href, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str repository_href: (required)
    ...
    def list_with_http_info(self, repository_href, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('repository_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['repository_href'] is None):  # noqa: E501
    ...
    def read(self, repositories_repository_version_href, **kwargs):  # noqa: E501
        """Inspect a repository version  # noqa: E501

        A customized named ModelViewSet that knows how to register itself with the Pulp API router.  This viewset is discoverable by its name. \"Normal\" Django Models and Master/Detail models are supported by the ``register_with`` method.  Attributes:     lookup_field (str): The name of the field by which an object should be looked up, in         addition to any parent lookups if this ViewSet is nested. Defaults to 'pk'     endpoint_name (str): The name of the final path segment that should identify the ViewSet's         collection endpoint.     nest_prefix (str): Optional prefix under which this ViewSet should be nested. This must         correspond to the \"parent_prefix\" of a router with rest_framework_nested.NestedMixin.         None indicates this ViewSet should not be nested.     parent_lookup_kwargs (dict): Optional mapping of key names that would appear in self.kwargs         to django model filter expressions that can be used with the corresponding value from         self.kwargs, used only by a nested ViewSet to filter based on the parent object's         identity.     schema (DefaultSchema): The schema class to use by default in a viewset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read(repositories_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.read_with_http_info(repositories_repository_version_href, **kwargs)  # noqa: E501

    def read_with_http_info(self, repositories_repository_version_href, **kwargs):  # noqa: E501
        """Inspect a repository version  # noqa: E501

        A customized named ModelViewSet that knows how to register itself with the Pulp API router.  This viewset is discoverable by its name. \"Normal\" Django Models and Master/Detail models are supported by the ``register_with`` method.  Attributes:     lookup_field (str): The name of the field by which an object should be looked up, in         addition to any parent lookups if this ViewSet is nested. Defaults to 'pk'     endpoint_name (str): The name of the final path segment that should identify the ViewSet's         collection endpoint.     nest_prefix (str): Optional prefix under which this ViewSet should be nested. This must         correspond to the \"parent_prefix\" of a router with rest_framework_nested.NestedMixin.         None indicates this ViewSet should not be nested.     parent_lookup_kwargs (dict): Optional mapping of key names that would appear in self.kwargs         to django model filter expressions that can be used with the corresponding value from         self.kwargs, used only by a nested ViewSet to filter based on the parent object's         identity.     schema (DefaultSchema): The schema class to use by default in a viewset.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.read_with_http_info(repositories_repository_version_href, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('repositories_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['repositories_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `repositories_repository_version_href` when calling `read`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{repositories_repository_version_href}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def repair(self, repositories_repository_version_href, repair, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair(repositories_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.repair_with_http_info(repositories_repository_version_href, repair, **kwargs)  # noqa: E501

    def repair_with_http_info(self, repositories_repository_version_href, repair, **kwargs):  # noqa: E501
        """repair  # noqa: E501

        Trigger an asynchronous task to repair a repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.repair_with_http_info(repositories_repository_version_href, repair, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('repositories_repository_version_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['repositories_repository_version_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `repositories_repository_version_href` when calling `repair`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '{repositories_repository_version_href}repair/', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
