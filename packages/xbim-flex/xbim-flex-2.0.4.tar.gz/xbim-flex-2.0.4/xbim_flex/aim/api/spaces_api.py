...
class SpacesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.spaces_generate_floor_plan_by_tenantid_and_assetmodelid_and_entityid_endpoint = _Endpoint(
            settings={
                'response_type': (SvgFloorplan,),
                'auth': [
                    'oauth2'
                ],
                'endpoint_path': "/{region}/aim/2.0/{tenantId}/Spaces(AssetModelId={AssetModelId}, EntityId={EntityId})/FloorPlan.Generate()",
                'operation_id': 'spaces_generate_floor_plan_by_tenantid_and_assetmodelid_and_entityid',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def spaces_generate_floor_plan_by_tenantid_and_assetmodelid_and_entityid(
        self,
        tenant_id,
        asset_model_id,
        entity_id,
        ...
        **kwargs
        ...
        """Gets the Floorplan for this space  # noqa: E501

        <span style='font-size: 17px;'>Summary:</span>Gets the Floorplan for this space.<br/>Return Type: <b>SvgFloorplan</b><br/><br/>  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.spaces_generate_floor_plan_by_tenantid_and_assetmodelid_and_entityid(tenant_id, asset_model_id, entity_id, region="UK", async_req=True)
        >>> result = thread.get()
        ...
        kwargs['region'] = \
            region
        return self.spaces_generate_floor_plan_by_tenantid_and_assetmodelid_and_entityid_endpoint.call_with_http_info(**kwargs)
