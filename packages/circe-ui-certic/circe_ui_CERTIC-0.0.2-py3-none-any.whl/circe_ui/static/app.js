...
async function initUI() {
    ...
    try {
        ...
        alert("Nous n'avons pas pu récupérer les transformations disponibles sur le serveur. Veuillez essayer plus tard ou contacter votre administrateur si le problème persiste.");
        console.log(err);
    }
