...
from faiss_searcher.base_encoder import BaseEncoder
from faiss_searcher.vecs_whitening import VecsWhitening
...
class BertEncoder(BaseEncoder):
    ...
    def encode(self, text_list: List[str], verbose: int = 1):
        ...
        data_gen = EncodeDataGenerator(data=text_list, dict_path=self.dict_path, batch_size=self.batch_size,
                                       maxlen=self.maxlen)
