...
def parse_axis(
    ...
    """
      ...
      >>> definition = ipa.surfaces.surface_eti.Definition(
      ...     underlying_definition=ipa.surfaces.surface_eti.EtiSurfaceDefinition(
      ...         instrument_code="BNPP.PA@RIC"
      ...     ),
      ...     surface_parameters=ipa.surfaces.surface_eti.EtiCalculationParams(
      ...         price_side=ipa.surfaces.surface_eti.PriceSide.MID,
      ...         volatility_model=ipa.surfaces.surface_eti.VolatilityModel.SVI,
      ...         x_axis=ipa.surfaces.surface_eti.Axis.STRIKE,
      ...         y_axis=ipa.surfaces.surface_eti.Axis.DATE,
      ...     ),
      ...     surface_tag="1",
      ...     surface_layout=ipa.surfaces.surface_eti.SurfaceLayout(
      ...         format=ipa.surfaces.surface_eti.Format.MATRIX, y_point_count=10
      ...     ),
      ... )
