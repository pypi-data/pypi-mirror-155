...
class Partition:
    ...
    def is_proper(self) -> bool:
        ...
        of the given ``BamFile``. An improper partition is a partition
        that refers to the whole ``BamFile``.
        """
        if (self._current, self._num_partitions) == (1, 1):
            return False
        else:
            return True
    ...
    def __str__(self) -> str:
        ...
        """
        return f"partition_{self._current}of{self._num_partitions}"
