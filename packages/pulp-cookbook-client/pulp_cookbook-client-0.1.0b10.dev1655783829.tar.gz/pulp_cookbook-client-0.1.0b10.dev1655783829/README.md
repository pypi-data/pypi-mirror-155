...
- API version: v3
- Package version: 0.1.0b10.dev1655783829
...
version = 'version_example' # str | version of the cookbook (optional)
    ...
    try:
        ...
        api_response = api_instance.create(name, repository=repository, file=file, artifact=artifact, upload=upload, version=version)
        pprint(api_response)
