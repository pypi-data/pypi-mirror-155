...
class QNdefNfcIconRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QNdefNfcIconRecord:PySide6.QtNfc.QNdefRecord) -> None: ...
    @overload
...
class QNdefNfcSmartPosterRecord(PySide6.QtNfc.QNdefRecord):
    ...
    @overload
    def addIcon(self, icon:PySide6.QtNfc.QNdefRecord) -> None: ...
    @overload
    ...
    @overload
    def addTitle(self, text:PySide6.QtNfc.QNdefRecord) -> bool: ...
    ...
    @overload
    def removeIcon(self, icon:PySide6.QtNfc.QNdefRecord) -> bool: ...
    @overload
    def removeIcon(self, type:Union[PySide6.QtCore.QByteArray, bytes]) -> bool: ...
    @overload
    def removeTitle(self, locale:str) -> bool: ...
    @overload
    def removeTitle(self, text:PySide6.QtNfc.QNdefRecord) -> bool: ...
    ...
    @overload
    def setUri(self, url:PySide6.QtNfc.QNdefRecord) -> None: ...
    def size(self) -> int: ...
...
class QNdefNfcTextRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QNdefNfcTextRecord:PySide6.QtNfc.QNdefRecord) -> None: ...
    @overload
    def __init__(self, other:PySide6.QtNfc.QNdefRecord) -> None: ...
...
class QNdefNfcUriRecord(PySide6.QtNfc.QNdefRecord):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, QNdefNfcUriRecord:PySide6.QtNfc.QNdefRecord) -> None: ...
    @overload
    def __init__(self, other:PySide6.QtNfc.QNdefRecord) -> None: ...
