...
class SeleniumBrowserUcMiddleware:
    ...
    def from_crawler(cls, crawler):
        ...
        driver_headless = crawler.settings.get('SELENIUM_DRIVER_HEADLESS')

        if driver_headless is None:
            raise NotConfigured('SELENIUM_DRIVER_HEADLESS. E.g. <True> to enable headless mode.')

        web = BrowserV2(use_headless=driver_headless)
        driver = web.driver
