...
class iFDO:
    ...
    def writeParsedDataToItems(self,data:dict,items:dict):
            ...
            if isinstance(data[img],list):
                ...
                for v in data[img]: # works if data[img] is dict
                    ...
                    try:
                        ...
                        #if v == 'image-camera-pitch-degrees':
                        #    print("ast.literal_eval(data[img][v])",ast.literal_eval(data[img][v]))
                    except Exception:
                        val = data[img][v]
                        #if v == 'image-camera-pitch-degrees':
                        #    print("data[img][v]",data[img][v])
        ...
        items = miqtc.recursivelyRemoveEmptyFields(items,contente2beRemoved=None)
        #print(items)
