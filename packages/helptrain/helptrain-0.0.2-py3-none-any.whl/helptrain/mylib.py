...
#在线下载
def load_data_fashion_mnist_online(batch_size, resize=None):
...
def load_data_fashion_mnist(batch_size, resize=None):
    ...
    trans = transforms.Compose(trans)
    mnist_train = torchvision.datasets.FashionMNIST(root='../linear-networks/', train=True, transform=trans, download=False)
    mnist_test = torchvision.datasets.FashionMNIST(root='../linear-networks/', train=True, transform=trans, download=False,)
