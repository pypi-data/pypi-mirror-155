...
class Players:
    ...
    def players_filter(object_id: int, data_type: int, argument: list = None):
        ...
        match data_type:
            case 1:
                return "select distinct rp.wyscout_id, rp.rankset_name from rankset.players as rp, rankset.teams as rt, wyscout.teams as wt " \
    ...
    def search(content: str):
        return f"select distinct rp.rankset_id as id, rp.rankset_name as name, rp.wyscout_id from rankset.players as rp" \
