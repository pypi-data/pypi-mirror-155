...
class Utilities:
    ...
    def displayResources(ressources : list):
        ...
        for r in ressources:
            array = []
            array.append(r.fileName.value+r.extension.value)
    ...
    def displayManPage(nameOfCmd : str=None):
        ...
        msg = """ Usage : archiver [COMMAND] [ARGS]
                    ...
                    Commands:
                        ...
                        import [FOLDER]  Import a folder into an archive
                        merge [ARCHIVE]  Merge two archives
                        extract [FOLDER]  Extract an archive into a folder
                        search [KEYWORD]  Search an archive for a keyword
                        select [ARCHIVE]  Select an archive to work with
                        doctor            Rebuild the database with JSON files
