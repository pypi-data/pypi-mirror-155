...
def main():
    ...
    try:
        ...
        if currentCmd == commands["new"]["name"]:
            ...
            Archive(nameHidden)
            print(Constants.MESSAGE_ARCHIVE_CREATED)
        ...
        #region Commande import
            ...
            if isdir(absPath):
                ...
                Archive(nameOfArchive).archiveResource(Resource(absPath, False))
                print("Le fichier a été archivé")
        ...
        #region Commande merge
            ...
            print("La fusion a été effectuée avec succès")
        ...
        #region Commande search
            ...
            if typeSearch != "--simple" and typeSearch != "--fullText":
                typeSearch = "--simple"
            else:
                values.pop(0)
            ...
            if extract:
                ...
                print("Les fichiers ont été extraits avec succès")
            else:
        ...
        #region Commande extract
            ...
            print("L'extraction a été effectuée avec succès")
            pass
        ...
        #region Commande select
            ...
            name = values[1]
            nameHidden = Utilities.getHiddenArchiveName(name)
            ...
            print("L'archive courante est maintenant " + name)
            pass
        ...
        #region Commande doctor
            ...
            print("La reconstruction a été effectuée avec succès")
            pass
