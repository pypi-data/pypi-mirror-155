    ...
    try:
        ...
        if not accoladez_config:
            ...
            if bucket is not None:
                ...
                store_api_url = f"https://{accoladez_config['urls']['store_service']}/api/v1"
                auth_api_url = f"https://{accoladez_config['urls']['auth_service']}/api/v1"
                ...
                dotenv.set_key("AUTH_SERVER_URL", auth_api_url)
