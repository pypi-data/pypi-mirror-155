...
def install():
    try:
        ...
        docker_install_script_path = os.path.join(absolute_package_path, "scripts", "docker-install.sh")
        docker_compose_install_script_path = os.path.join(absolute_package_path, "scripts", "docker-compose-install.sh")
