...
def parse_ftcalib_args():
    ...
    parser.add_argument("-fun",  type=[str.lower, int], dest="fun", nargs=2, default=["poly", 2], help="CalibrationFunction followed by number of parameters per flavour (default: %(default)s). Available calibration functions: ['poly', 'npline', 'bspline']")
