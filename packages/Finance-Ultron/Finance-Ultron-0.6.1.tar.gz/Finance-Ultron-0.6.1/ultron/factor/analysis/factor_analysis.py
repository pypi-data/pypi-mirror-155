...
from ultron.factor.experimental.portfolio.meanvariancebuilder import mean_variance_bulder as f_mean_variance_bulder
...
def er_portfolio_analysis(er: np.ndarray,
    ...
    if method == 'risk_neutral':
        ...
        status, _, weights = f_mean_variance_bulder(er=er,
