...
help_menu = """
    ...
    Github:\n
    https://github.com/brootware/gtredactkit
    
    Follow me on Twitter!\n
    https://twitter.com/brootware
    
    Example usage:\n
        gtredactkit --text 'This is my ip: 127.0.0.1. My email is brute@gmail.com'\n
        gtredactkit --file [file/filestoredact]\n
        gtredactkit --file redacted_file --unredact .hashshadow.json\n
        gtredactkit --file file --customfile custom.json\n
    """
...
def arg_helper() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="""
                ...
                Usage: gtredactkit -f [redacted_file] -u [.hashshadow.json]
                """
    )
    parser.add_argument(
        "-d",
        ...
        help="""
                ...
                Usage: gtredactkit -f [file/filestoredact] -d [redacted_dir]
                """
    )
    parser.add_argument(
        "-c",
        ...
        help="""
                ...
                Usage: gtredactkit -f [file/filestoredact] -c [customfile.json]
                """
    )
    parser.add_argument(
        '-r',
