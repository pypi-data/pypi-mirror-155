...
# x ... expand 2x ... buggy
HELPTEXT=""" a/A ... SAVE AVI/ stop saving
 s ... saving JPG
 ...
 c/C ... red cross on/off
 hjkl ... move the red cross (HJKL)
...
def disp_mutext(lena, wrapped_text_o):
    ...
    offy = 0 + int((img.shape[0] - gap*nlines) / 2)
                        ...
                        if cross is None:
                            ...
                            if os.path.exists( os.path.expanduser('~/.flashcam_unicross.txt') ):
                                try:
                                    ...
                                    print("X... problem to open ~/.flashcam_unicross.txt")
