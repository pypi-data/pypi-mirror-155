...
def main():
    ...
    try:
        ...
        version = '0.0.0'
        init = 'CMSMonitoring/__init__.py'
    ...
    dist = setup(
        name='cmsmonitoring_test',
        version=version,
        author='Ceyhun Uzunoglu',
        author_email='ceyhunuzngl@gmail.com',
        license='MIT',
        description='CMS Monitoring utilities',
        long_description='CMS Monitoring utilities',
        packages=['cmsmonitoring_test'],
        package_dir={'cmsmonitoring_test': 'CMSMonitoring'},
        install_requires=parse_requirements("requirements.txt"),
        scripts=['bin/%s' % s for s in os.listdir('bin')],
        # url='https://github.com/mrceyhun/CMSMonitoring',
