...
.. code-block:: shell
   ...
   mltk profile keyword_spotting_mobilenetv2 --device --accelerator MVP
    ...
    Flash, Model File Size (bytes): 259.0k
    ...
    | 1     | depthwise_conv_2d | 126.0k | 54.0k  | 189.1k     | 209.5k     | 4.2m     | 1x30x25x8,1x3x3x8,8     | 1x30x25x8    | Multiplier:1 padding:same stride:1x1 activation:relu6  |
    ...
    | 5     | pad               | 241.1k | 0      | 0          | 967.9k     | 11.9m    | 1x30x25x48,4x2          | 1x31x27x48   | Type=padoptions                                        |
    | 6     | depthwise_conv_2d | 196.6k | 84.2k  | 156.0k     | 265.3k     | 3.3m     | 1x31x27x48,1x3x3x48,48  | 1x15x13x48   | Multiplier:1 padding:valid stride:2x2 activation:relu6 |
    ...
    | 10    | conv_2d           | 151.3k | 74.9k  | 121.7k     | 3.6k       | 1.5m     | 1x15x13x48,8x1x1x48,8   | 1x15x13x8    | Padding:same stride:1x1 activation:none                |
    ...
    | 18    | conv_2d           | 43.5k  | 21.5k  | 35.0k      | 3.6k       | 480.0u   | 1x8x7x48,8x1x1x48,8     | 1x8x7x8      | Padding:same stride:1x1 activation:none                |
    | 19    | add               | 448.0  | 0      | 2.0k       | 2.5k       | 30.0u    | 1x8x7x8,1x8x7x8         | 1x8x7x8      | Activation:none                                        |
    | 20    | conv_2d           | 51.1k  | 21.5k  | 48.4k      | 3.5k       | 630.0u   | 1x8x7x8,48x1x1x8,48     | 1x8x7x48     | Padding:same stride:1x1 activation:relu6               |
    ...
    | 22    | conv_2d           | 43.5k  | 21.5k  | 35.0k      | 3.6k       | 450.0u   | 1x8x7x48,8x1x1x48,8     | 1x8x7x8      | Padding:same stride:1x1 activation:none                |
    ...
    | 25    | pad               | 23.3k  | 0      | 0          | 81.5k      | 990.0u   | 1x8x7x48,4x2            | 1x9x9x48     | Type=padoptions                                        |
    ...
    | 28    | conv_2d           | 53.8k  | 24.6k  | 46.0k      | 3.5k       | 600.0u   | 1x4x4x16,96x1x1x16,96   | 1x4x4x96     | Padding:same stride:1x1 activation:relu6               |
    ...
    | 33    | depthwise_conv_2d | 32.2k  | 13.8k  | 18.8k      | 22.9k      | 390.0u   | 1x4x4x96,1x3x3x96,96    | 1x4x4x96     | Multiplier:1 padding:same stride:1x1 activation:relu6  |
    ...
    | 68    | mean              | 0      | 0      | 0          | 315.9k     | 3.9m     | 1x2x2x384,2             | 1x384        | Type=reduceroptions                                    |
    | 69    | fully_connected   | 6.2k   | 3.1k   | 4.7k       | 2.1k       | 90.0u    | 1x384,8x384,8           | 1x8          | Activation:none                                        |
    | 70    | softmax           | 40.0   | 0      | 0          | 7.1k       | 90.0u    | 1x8                     | 1x8          | Type=softmaxoptions                                    |
    +-------+-------------------+--------+--------+------------+------------+----------+-------------------------+--------------+--------------------------------------------------------+
