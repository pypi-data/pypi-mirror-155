...
add_stacklevel: Callable[[int, Dict[str, Any]], Dict[str, Any]]
if (sys.version_info < (3, 8)):
    def add_stacklevel(stacklevel: int, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        return kwargs
else:
    def add_stacklevel(stacklevel: int, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        kwargs.setdefault('stacklevel', stacklevel)
        return kwargs
...
class ExtendedLogger(_logger_class):
    ...
    def findCaller(self, stack_info=False, stacklevel=1, *args, **kwargs):
        """
    ...
    @logging_method
    def trace(self, message, *args, stacklevel: int = 1, **kwargs):
        self.log(TRACE_LEVEL_NUM, message, *args, **add_stacklevel(stacklevel+1, kwargs))
    
    @logging_method
    def develop(self, message, *args, stacklevel: int = 1, **kwargs):
        self.log(DEVELOP_LEVEL_NUM, message, *args, **add_stacklevel(stacklevel+1, kwargs))
