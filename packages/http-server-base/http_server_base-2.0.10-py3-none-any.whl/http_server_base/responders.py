...
class BasicResponder(IResponder):
    ...
    @staticmethod
    @error_decorator
    def update_error_response(handler: ILogged_RequestHandler, response: HTTPResponse, message: str, error: str = None):
        pass

    @overload
    @staticmethod
    def resp_success(handler: ILogged_RequestHandler, code: int = 200, reason: str = None, message: str = None, result = None):
        pass
    
    @staticmethod
    def resp_success(handler: ILogged_RequestHandler, *args, **kwargs):
        return super().resp_success(handler, *args, **kwargs)
...
class TextBasicResponder(BasicResponder):
    @staticmethod
    @error_decorator
    def update_error_response(handler: ILogged_RequestHandler, response: HTTPResponse, message: str = None, error: str = None):
        pass
...
class HtmlBasicResponder(BasicResponder):
    ...
    def update_error_response(handler: ILogged_RequestHandler, response: HTTPResponse, message: str = None, error: str = None):
        ...
        _html = f'<html><title>{code}: {reason}</title><body>{message}<br/>{error}</body></html>'
...
class JsonCustomResponder(BasicResponder):
    ...
    @overload
    @staticmethod
    def resp_success(handler: ILogged_RequestHandler, response: JsonSerializable = None):
        pass
