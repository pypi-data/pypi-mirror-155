...
trained = False
model_path = os.path.join(os.getcwd(), "src", "Unet", "models")
# проверку переделать
...
if not trained:
    ...
    model.save_weights('src/Unet/models/{}model'.format(SAVING_NAME))
...
for i in range(10):
    ...
    im.save('src/Unet/results/test{}{}.{}.png'.format(EPOCHS_NUMBER, BATCH_SIZE, i))
