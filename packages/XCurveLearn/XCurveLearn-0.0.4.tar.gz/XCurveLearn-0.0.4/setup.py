...
setuptools.setup(
    name="XCurveLearn",                     # This is the name of the package
    version="0.0.4",                      # The initial release version
    author="qqgroup",                     # Full name of the author
    author_email='  ',
    description="machine learning package",
    url='https://gitee.com/Statusrank/xcurve-opt',
    ...
    py_modules=["XCurveLearn"],             # Name of the python package
    package_dir={'XCurveLearn':'XCurveLearn'},
