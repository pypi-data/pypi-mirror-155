...
class AzStorageManager(AzResourceManagerBase, IAzStorageManager):
    ...
    def add_network_rule(self, storage_account_name: str, firewall_rule_cidr: FirewallRuleCIDR):
        return self._repository.add_network_rule(storage_account_name=storage_account_name,
                                                 firewall_rule_cidr=firewall_rule_cidr)

    def remove_network_rule(self, storage_account_name: str, firewall_rule_cidr: FirewallRuleCIDR):
        return self._repository.remove_network_rule(storage_account_name=storage_account_name,
                                                    firewall_rule_cidr=firewall_rule_cidr)
