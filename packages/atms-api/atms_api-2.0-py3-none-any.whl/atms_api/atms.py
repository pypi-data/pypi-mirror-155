...
def _get_org_info(el_name: str, cntr_id='', cntr_name=''):
...
class RouteStatus(Atms):
    ...
    def xml_el(self):
        ...
        el.append(_get_org_info('organization-information', 'MILWAUKEE', 'Milwaukee Center'))
