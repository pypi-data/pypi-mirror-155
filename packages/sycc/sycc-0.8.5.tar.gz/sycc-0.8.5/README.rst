...
a:此版本为作者开源版,若想查看源代码使用请 ``git clone https://github.com/py-lwb/sycc.git`` 下载或 ``sycc1.tk/sycc.tar.gz``
** 注 ** ： 0.7.5源码包已上传，请自行查看
...
a:作者偷懒，不想每次改版本号，所以用 ``pip show module`` 的方式获取版本号
（进行列表提取，字符串切片拼接，多重判断等），如果获取失败将会显示定制版
