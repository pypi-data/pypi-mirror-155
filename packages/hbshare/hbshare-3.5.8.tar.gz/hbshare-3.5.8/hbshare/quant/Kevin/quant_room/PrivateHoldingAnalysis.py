...
class HoldingAnalysor:
    ...
    def _load_portfolio_weight_series(self):
        ...
        return holding_df.set_index('ticker')['weight']
...
if __name__ == '__main__':
    ...
    tmp = HoldingAnalysor("因诺聚配中证500指数增强", "20220531", "000905").get_construct_result(isPlot=False)
    # print(tmp['style_df'])
