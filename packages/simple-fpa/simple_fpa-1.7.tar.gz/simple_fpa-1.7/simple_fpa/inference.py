...
def make_ci_asy(self, confidence, hyp):
    ...
    add_column(self, '_q_cia', self.core_ci)
    add_column(self, '_v_cia', self.A_4*self.core_ci)
    add_column(self, '_bs_cia', self.a*self.A_3*self.A_4*self.core_ci)
    add_column(self, '_rev_cia', self.M*self.a*self.A_3*self.A_4*self.core_ci)
