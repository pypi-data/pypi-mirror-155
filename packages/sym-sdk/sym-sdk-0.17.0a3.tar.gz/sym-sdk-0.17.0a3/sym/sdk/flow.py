...
class Environment(SymResource, ABC):
    """The :class:`~sym.sdk.flow.Environment` class represents a container for sym_flows
    that share configuration values`.
    ...
    def integrations(self) -> Dict[str, "Integration"]:
        """A dictionary with the integration structure defined for the :class:`~sym.sdk.strategies.integration.Integration`."""
