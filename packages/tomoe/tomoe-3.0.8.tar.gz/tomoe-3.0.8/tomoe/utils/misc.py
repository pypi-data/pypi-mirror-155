...
def log_file(file: str, size: str, took: str):
    ...
    """
    logging.info(
        f'Successfully downloaded {file}: {size} MB, took: {took} Seconds')
...
def log_final(taken: str, total_size: str):
    """Final log
        ...
        total_size : str
            Total size
    """
    logging.info(f"Successfully downloaded all images taken {taken} minutes with total size {total_size} MB")