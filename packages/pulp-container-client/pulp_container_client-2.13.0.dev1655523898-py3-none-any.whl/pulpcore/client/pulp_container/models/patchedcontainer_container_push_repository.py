...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, description=None, manifest_signing_service=None, retain_repo_versions=None, pulp_labels=None, name=None, local_vars_configuration=None):  # noqa: E501
