...
class PatchedcontainerContainerPushRepository(object):
    ...
    def __init__(self, manifest_signing_service=None, name=None, pulp_labels=None, retain_repo_versions=None, description=None, local_vars_configuration=None):  # noqa: E501
