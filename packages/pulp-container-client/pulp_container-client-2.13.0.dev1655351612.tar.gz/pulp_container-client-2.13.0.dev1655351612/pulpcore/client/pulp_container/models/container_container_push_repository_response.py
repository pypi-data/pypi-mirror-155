...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, versions_href=None, pulp_labels=None, manifest_signing_service=None, name=None, retain_repo_versions=None, pulp_created=None, latest_version_href=None, description=None, pulp_href=None, local_vars_configuration=None):  # noqa: E501
