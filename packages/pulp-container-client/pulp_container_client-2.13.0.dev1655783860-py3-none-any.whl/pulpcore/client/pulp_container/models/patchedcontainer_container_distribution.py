...
class PatchedcontainerContainerDistribution(object):
    ...
    def __init__(self, name=None, repository=None, pulp_labels=None, base_path=None, content_guard=None, repository_version=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
