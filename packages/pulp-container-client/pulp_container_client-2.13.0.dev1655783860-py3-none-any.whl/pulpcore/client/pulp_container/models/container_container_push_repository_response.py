...
class ContainerContainerPushRepositoryResponse(object):
    ...
    def __init__(self, manifest_signing_service=None, versions_href=None, name=None, pulp_href=None, pulp_labels=None, pulp_created=None, retain_repo_versions=None, latest_version_href=None, description=None, local_vars_configuration=None):  # noqa: E501
