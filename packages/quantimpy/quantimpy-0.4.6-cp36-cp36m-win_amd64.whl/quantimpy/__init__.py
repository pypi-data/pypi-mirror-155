...
This code is inspired by and partly based on the `QuantIm library`_ C/C++ library
for scientific image processing. The source code is available on `Github`_.
