...
def point_picker(img_fpath: str) -> Tuple[int, int]:
    ...
    plt.imshow(img)
    point_coords_xy = plt.ginput(1)[0]
    plt.close()
...
if __name__ == "__main__":
    ...
    img_dims_wh = (5472, 3648)
    px_yx = (124, 1036)
    m_per_lat, m_per_lon = get_latlon_m(35.9)
    delta_lat = 0
    ...
    # Tile gsd:
    print(get_gsd(25))
    print(get_gsd(25, img_width=1824)) 

    img_dir = "/media/findux/DATA/Documents/Malta_II/surveys/GCPs/images/59"
    img_dir = "/media/findux/DATA/Documents/Malta_II/surveys/GCPs/gnejna_gcps/gnejna_7m/"
    img_dir = "/media/findux/DATA/Documents/Malta_II/surveys/GCPs/gnejna_gcps/gnejna_30_m/"
    img_dir = "/media/findux/DATA/Documents/Malta_II/surveys/GCPs/gnejna_gcps/gnejna_10m/"
    img_dir = "/media/findux/DATA/Documents/Malta_II/surveys/GCPs/paradise_bay_gcps/49/"
    collect_clicks_on_all_images(img_dir, 7)