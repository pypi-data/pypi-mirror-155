...
def new_tile_cutter(fdir: str, nrows: int, ncols: int,
                             ...
                             inject_gps_exif: bool = True, inject_uav_yaw: bool = True) -> Tuple[str, dict]:
    """
...
if __name__ == "__main__":
    ...
    fpath_src = "/home/findux/Desktop/images/"
    fpath_dst = "/home/findux/Desktop/new_tiles"
    tile_dir, gsd_dict = new_tile_cutter(fpath_src, 2, 3, 7, fpath_dst)
    print(gsd_dict)