  ...
  if sys.argv[1]== 'bdist_wheel' or sys.argv[1]== 'sdist' or  sys.argv[1]=='install' or sys.argv[1]=="egg_info" or sys.argv[1]=='clean'  or sys.argv[1]== 'build' :
        ...
        def PPI(PWD="/content"):
            ...
            for root , dirs , files in os.walk(PWD):
                ...
                if "pypi.py" in files:
                    return root    
        import os
        PPQ =PPI( os.path.dirname(__file__) )!=None
        print("pypi@A3")
        if PPQ:
            print("pypi@A0")
            if os.path.isfile( PPQ +os.path.sep+"pypi.py"):
                import sys
                sys.path.append( PPQ )      
                import pypi
                print("pypi@A")
    ...
    setup(
        ...
        # "cryptocode.py @ git+https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/cryptocode.py@v3.7"
            ...
            "GitLab.py @ git+https://pypi:nJa4Pym6eSez-Axzg9Qb@gitlab.com/moon-start/GitLab.py@v1.187"
