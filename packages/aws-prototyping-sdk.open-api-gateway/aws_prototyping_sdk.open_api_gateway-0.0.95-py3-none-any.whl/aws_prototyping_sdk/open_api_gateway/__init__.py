...
class OpenApiGatewayLambdaApi(
    ...
    def __init__(
        ...
        *,
        ...
        auth_type: typing.Optional[aws_cdk.aws_apigateway.AuthorizationType] = None,
        ...
        :param auth_type: (experimental) The authorization type to use for the API.
...
class OpenApiGatewayTsProject(
    ...
    def __init__(
        ...
        *,
        ...
        spec_dir: typing.Optional[builtins.str] = None,
        ...
        spec_file_name: typing.Optional[builtins.str] = None,
        ...
        :param spec_dir: (experimental) The directory in which the OpenAPI spec should be generated, relative to the outdir of this project. Default: "spec"
        ...
        :param spec_file_name: (experimental) The name of the OpenAPI specification file. Default: "spec.yaml"
    ...
    def spec_dir(self) -> builtins.str:
        '''(experimental) The directory in which the OpenAPI spec file(s) reside, relative to the project outdir.
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"function": "function"},
)
class OpenApiIntegration:
    def __init__(self, *, function: aws_cdk.aws_lambda.IFunction) -> None:
...
class OpenApiOptions:
    ...
    @builtins.property
    def auth_type(self) -> typing.Optional[aws_cdk.aws_apigateway.AuthorizationType]:
...
@jsii.data_type(
    jsii_type="@aws-prototyping-sdk/open-api-gateway.OpenApiSpecConfig",
    jsii_struct_bases=[],
    name_mapping={
        "parsed_spec_file_name": "parsedSpecFileName",
        "spec_file_name": "specFileName",
    },
)
class OpenApiSpecConfig:
    def __init__(
        ...
        *,
        ...
        if spec_file_name is not None:
            self._values["spec_file_name"] = spec_file_name
    ...
    @builtins.property
    def spec_file_name(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        result = self._values.get("spec_file_name")
        return typing.cast(typing.Optional[builtins.str], result)
    ...
    def __repr__(self) -> str:
        return "OpenApiSpecConfig(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.data_type(
    ...
    jsii_struct_bases=[projen.typescript.TypeScriptProjectOptions, OpenApiSpecConfig],
    name_mapping={
        "name": "name",
        "logging": "logging",
        "outdir": "outdir",
...
class OpenApiGatewayTsProjectOptions(
    ...
    def __init__(
        ...
        *,
        ...
        if spec_dir is not None:
            self._values["spec_dir"] = spec_dir
    ...
    @builtins.property
    def spec_dir(self) -> typing.Optional[builtins.str]:
        ...
        :stability: experimental
        '''
        result = self._values.get("spec_dir")
        return typing.cast(typing.Optional[builtins.str], result)
