...
COLORAMA_COLORS = {
    ...
    (139, 0, 0): Fore.RED,
    (0, 139, 0): Fore.GREEN,
    (139, 139, 0): Fore.YELLOW,
    (0, 0, 139): Fore.BLUE,
    (139, 0, 139): Fore.MAGENTA,
    (0, 139, 139): Fore.CYAN,
    (139, 139, 139): Fore.WHITE,
}

DISCORD_UNSUPPORTED_COUNT = 8
DISCORD_COLORS = dict(COLORAMA_COLORS.items()[8:])