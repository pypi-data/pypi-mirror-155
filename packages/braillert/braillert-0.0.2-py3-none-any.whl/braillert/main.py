...
def main() -> None:
    ...
    argument_parser.add_argument("-fp", "--file-path", dest="file_path",
            choices=tuple(ColorTypes), required=True, help=FP_ARG_HELP_STRING)
    argument_parser.add_argument("-m", "--mode", dest="mode",
            choices=tuple(ColorTypes), default="rich", help=MODE_ARG_HELP_STRING)
