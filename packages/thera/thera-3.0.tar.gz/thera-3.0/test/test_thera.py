...
class TestTitle(unittest.TestCase):
    def setUp(self):
        ...
        self.converter.dist_dir = os.path.join(self.tempdir, 'dist')

    def test_h1_title(self):
        md = '#Hello world'
        mdpath = os.path.join(self.tempdir, 'test.md')
        with io.open(mdpath, 'w', encoding='ISO-8859-1') as f:
            f.write(md)
...
class TestConvert(unittest.TestCase):
    ...
    def test_with_template(self):
        ...
        template = '''
            ...
            '''
        temppath = os.path.join(self.tempdir, 'test.html')
        with io.open(temppath, 'w', encoding='ISO-8859-1') as f:
            f.write(template)
...
class TestSlug(unittest.TestCase):
    ...
    def test_use_filename(self):
        md = '# My title'
        mdpath = os.path.join(self.tempdir, 'howdy.md')
        with io.open(mdpath, 'w', encoding='ISO-8859-1') as f:
            f.write(md)
        data, content = self.converter.convert(mdpath)
