...
class VoiceControlStatusIndicator extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    ...
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.UseSignal, { signal: this.signal }, (sender, status) => {
            ...
            const icon = status.enabled ? _icons__WEBPACK_IMPORTED_MODULE_3__.recognitionEnabledIcon : _icons__WEBPACK_IMPORTED_MODULE_3__.recognitionDisabledIcon;
            const text = this.trans.__('Last voice recognition result: %1 with confidence %2', status.lastResult, status.lastConfidence);
            const shortText = this.trans.__('%1 (%2%)', status.lastResult, status.lastConfidence ? Math.round(status.lastConfidence * 100) : '?');
            const controller = this.controller;
            return react__WEBPACK_IMPORTED_MODULE_0__.createElement(_jupyterlab_statusbar__WEBPACK_IMPORTED_MODULE_2__.GroupItem, { spacing: 0, title: text, onClick: () => { controller.isEnabled ? controller.disable() : controller.enable(); } },
...
class VoiceController {
    constructor(commandRegistry, trans, palette) {
        ...
        if (!SpeechRecognition) {
            (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(trans.__('Speach recognition not supported'), trans.__('Your browser does not support speech recognition.'));
        ...
        this.recognition.onerror = (event) => {
            ...
            switch (event.error) {
                case 'audio-capture':
                    (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(title, 'Microphone not detected');
                    break;
                case 'not-allowed':
                    (0,_jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.showErrorMessage)(title, 'Access to microphone was denied or blocked');
                    break;
                case 'no-speech':
    ...
    matchPhrase(phrase) {
        ...
        let command = this.jupyterCommands.get(phrase);
        console.log(phrase, command, !!command);
        if (!!command) {
            ...
            for (let [candidateLabel, command] of this.jupyterCommands.entries()) {
                const matchScore = Math.min(((_a = _lumino_algorithm__WEBPACK_IMPORTED_MODULE_0__.StringExt.matchSumOfDeltas(candidateLabel, phrase)) === null || _a === void 0 ? void 0 : _a.score) || Infinity, ((_b = _lumino_algorithm__WEBPACK_IMPORTED_MODULE_0__.StringExt.matchSumOfDeltas(normalise(command.caption), phrase)) === null || _b === void 0 ? void 0 : _b.score) || Infinity);
                if (matchScore < best) {
                    best = matchScore;
    ...
    handleSpeechResult(event) {
        ...
        console.log(speech == 'yes', this._currentSuggestions);
    ...
    updateGrammar() {
        ...
        // const commands = 
        this.commandRegistry.listCommands()
...
const plugin = {
    ...
    activate: (app, palette, settingRegistry, statusBar, translator) => {
        ...
        app.commands.addCommand('vc:type-text', {
            ...
            execute: (args) => (0,_commands__WEBPACK_IMPORTED_MODULE_7__.typeText)(args)
        });
        app.commands.addCommand('vc:delete-text', {
            label: trans.__('Delete Text From Focused Element'),
            execute: (args) => (0,_commands__WEBPACK_IMPORTED_MODULE_7__.deleteText)(args)
        });
        ...
        app.commands.addCommand('vc:open-notebook', {
            ...
            execute: (args) => app.commands.execute('filebrowser:open-path', { path: args.path + '.ipynb' })
        });
...
//# sourceMappingURL=lib_index_js.b42a108f8d3c02ad8875.js.map