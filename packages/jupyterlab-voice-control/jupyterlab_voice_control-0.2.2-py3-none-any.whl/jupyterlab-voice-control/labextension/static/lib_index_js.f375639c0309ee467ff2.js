        ...
        for (const command of this.commands) {
            ...
            if (match != null) {
                if (!this.commandRegistry.hasCommand(command.command)) {
                    this.communicate(this.trans.__('Matched "%1" phrase but command "%2" is not in the registry', command.phrase, command.command));
                    return [];
                }
...
//# sourceMappingURL=lib_index_js.f375639c0309ee467ff2.js.map