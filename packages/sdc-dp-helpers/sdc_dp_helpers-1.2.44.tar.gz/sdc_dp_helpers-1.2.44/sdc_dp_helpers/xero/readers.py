...
class CustomXeroReader:
    ...
    def __init__(self, **kwargs):
        ...
        self.auth_token.tenant_ids = self.config.get("tenant_ids", [])
    ...
    def traverse_reports(self):
        ...
        for report_name in self.config.get("reports", []):
            ...
            if report_name in ["BalanceSheet", "ProfitAndLoss"]:
                trackingcategories = (i for i in self.xero_obj.trackingcategories.all() if i!=None )
                ...
                if report_name == 'BalanceSheet':
                    ...
                    request_params.update({
                        "date": self.config.get("from_date")
                    })
                ...
                for contact_id in self.xero_obj.contacts.filter(AccountNumber__startswith='999999'):
                    request_params.update({
    ...
    def fetch_modules(self):
        ...
        """
        self.xero_creds = pixie.refresh_auth_token(self.client_id, self.auth_token )
