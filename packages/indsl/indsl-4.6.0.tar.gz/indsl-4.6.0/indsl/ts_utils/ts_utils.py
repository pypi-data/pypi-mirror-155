...
def fill_gaps(
    ...
    Args:
        data: Time series to impute.
        granularity: Temporal resolution of uniform time series, before resampling. Defaults to None.
    ...
    try:
        ...
        raise UserValueError(f"Unable to convert {granularity} to time resolution", RuntimeWarning)
    ...
    if ffill_resolution:
        try:
            ...
            raise UserValueError(f"Unable to convert {ffill_resolution} to time resolution", RuntimeWarning)
    ...
    if interpolate_resolution is not None:
        try:
            ...
            raise UserValueError(f"Unable to convert {interpolate_resolution} to time resolution", RuntimeWarning)
