...
def parse_args():
    parser = argparse.ArgumentParser(description="Honeycheck detects rogue dhcp "
                                                "servers and provides a modular "
                                                "and fully configurable action "
                                                "environment in case they are found")

    parser.add_argument("-c", "store", help="Configuration file", required=True)
    parser.parse_args()
